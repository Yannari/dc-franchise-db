...
export const SECRET_LINES = {
  pull: [
    ...
    { id: 'pk.04', when: { kissed: true }, stage: 'On the daybeds, late, once the others have gone in.', turns: [['b', "This is a bad idea."], ['a', "Then stop me."]], beat: "{b} doesn't stop {a.obj}." },
    { id: 'pk.05', when: { kissed: true }, turns: [['a', "I can't stop thinking about you."], ['b', "Then stop talking."]], beat: "It's a long kiss." },
  ...
  'bed-share': [
    ...
    { id: 'bs.b.02', when: { of: 'bed' }, stage: 'The bedroom, after the others have settled.', turns: [['a', "I'll stay on my side."], ['b', "You don't have to."]], beat: "{a} doesn't stay on {a.posAdj} side." },
    ...
    { id: 'bs.k.02', when: { of: 'kiss' }, stage: 'Under the covers, late.', turns: [['a', "I've been wanting to do this since you walked in."]], beat: 'They kiss for a long time.' },
  ...
  reunite: [
    ...
    { id: 'ru.w.04', when: { of: 'warm' }, turns: [['b', "I can't believe I'm doing this."], ['a', "Doing what?"], ['b', "Giving you another chance."]], beat: "{a} can't stop grinning." },
  ...
  'apology-rejected': [
    ...
    { id: 'aj.f.01', when: { of: 'final' }, turns: [['b', "Stop. Please. I've said no, and I mean it."], ['a', "I'll stop."]], beat: "{a} walks away, and doesn't look back." },
  ...
  photos: [
    { id: 'ph.k.01', when: { of: 'kiss' }, stage: "{a} turns the photo over. It's {b}, mid-kiss.", turns: [['a', "You're kissing them."], ['b', "It was one kiss."], ['a', "One is enough."]], beat: 'The photo falls onto the bench.' },
    { id: 'ph.k.02', when: { of: 'kiss' }, stage: 'The photo is of {b} kissing somebody new.', turns: [['a', "You walked back in like nothing happened."], ['b', "Nothing serious did happen."]], beat: '{a} laughs, and then starts crying.' },
    ...
    { id: 'ph.b.03', when: { of: 'bed' }, stage: 'A photo of {b} in bed at Casa Amor, not alone.', turns: [['a', "I slept on my own every night that week."]], beat: "{b} can't look up from the floor." },
  ],
};
