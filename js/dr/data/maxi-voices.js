  ...
  kind('group-slots',
    ...
    + 'is backup — fewest bars, most choreography, smallest spotlight.', P(
      tier('got-it', 'She got the position she wanted — and {d} is worth wanting.', [
        ...
        '{d} goes to {a} and the room clocks it. That is the slot with the verse, the front of the choreography, and the spotlight that matters. She knows what she has.',
        '{a} grabs {d} and does not hesitate. {d} is the position with the most material and the most risk, and she took it like she packed for it.',
        '{d} lands in {a}\'s lap and she exhales. The slot she wanted. The bars she can write to. The position in the number where the camera has no choice but to find her.',
        '{a} walks away from the draft with {d}. That is the position that makes or breaks a girl group week, and she chose it on purpose.',
        '{d}. {a} takes it and does not try to hide the grin. That is the position every queen in the room wanted, and she is the one walking away with it. The draft is over and she won it.',
      ]),
      tier('settled', '{d} is not what she came for, but she can build on it.', [
        ...
        '{d} is not what {a} came for. She wanted the front of the number and she got the middle of it. But {d} has a verse and a place in the choreo, and she is already figuring out how to make it louder than it looks on paper.',
        '{a} settles into {d}. Not her first choice — everybody saw her reach for something bigger — but {d} has room in it. A smart queen can find a moment inside {d} that the lead does not have.',
        '{d} goes to {a} and she takes it without complaint. It is not the slot she rehearsed for in her head, but it is a real position with real bars and she is going to treat it that way.',
        '{a} takes {d} and makes peace with it in about four seconds. {d} is not the lead. It is not the spotlight. But it is a position she can build on and she knows the difference between settling and giving up.',
        '{d} was not the plan. {a} takes it anyway, because {d} is the kind of slot where a queen who works harder than the material gets noticed. She is already writing in her head.',
        '{a} picks up {d} the way you pick up a tool that is not the one you wanted but will get the job done. {d} has a verse. {d} has choreography. She can make this work.',
        '{d} is what is left by the time {a} picks, and she does not waste time mourning what she missed. {d} has bars. She will make them count.',
      ]),
      tier('left-over', '{d} is what nobody else wanted, and she knows why.', [
        ...
        'Nobody reached for {d}. {a} takes it because it is what is there. {d} is the slot with the least verse and the most choreography, and she is already calculating how to exist inside it.',
        '{d} goes to {a} by default. The room picked around it. She knows why — {d} is the position where you disappear if you are not careful, and she is planning not to disappear.',
        '{a} ends up with {d}. Not by choice — by elimination. {d} is the kind of slot the room leaves on the table, and {a} is the queen who has to find something inside it worth showing the panel.',
        '{d} is what nobody wanted and {a} is the queen holding it. The verse is short. The choreography is long. The spotlight is somewhere else. She takes it to her station and starts writing anyway.',
        'The room avoided {d} and {a} is the one left holding it. {d} has the fewest bars and the smallest moment in the number. She knows what that means on judging night.',
      ]),
      tier('picked-last', 'Picked last. {d} is barely a position.', [
        ...
        '{a} gets {d}. Last. The position that is barely a position — fewest bars, most background, smallest spotlight in the whole number. She takes it to her station and stares at it.',
        '{d} is what is left after everybody else has picked, and {a} is holding it. Not a slot. Not a moment. {d} is the back of the number and a prayer that somebody on the panel notices her.',
        '{a} takes {d} because there is nothing else to take. Every other queen picked around it. {d} is the position where a girl group buries you if you let it, and {a} is the one standing in the grave.',
        'Last pick. {d}. {a} holds it and the room does the thing where they do not look at the queen who got the worst position because looking would be admitting what everybody already knows.',
        '{d} goes to {a} and she does not argue because there is nothing to argue with. {d} is the back of the number. The shortest verse. The most choreography. She has to make something out of almost nothing.',
      ]),
    )),
  kind('partner',
...
export const WALKTHROUGH_VOICES = [
  ...
  walk('makeover', 'The two of them side by side, and whether they read as family.', [
    'The host looks at {a} and her partner side by side. One question: do they look like they belong together? The note is about the gap — the mug, the hair, the styling — and whether {a} can close it before the runway.',
    ...
    '{a} stands next to her partner. The host studies the pairing the way the panel will study it — two people who are supposed to look like they belong to each other. The note is about everything that currently says they do not.',
    ...
    '{a}\'s partner stands in whatever {a} has built so far. The host looks at the two of them. \"I see it\" or \"I do not see it yet.\" The \"yet\" is the useful part.',
    'The host asks {a} to show her the look so far. {a}\'s partner presents what {a} has painted and styled. The host evaluates the pairing as a unit. Not two individuals who happen to be standing next to each other.',
    '{a} and her partner stand together. The host walks around them. The note is about the one thing that breaks the illusion — a mismatched brow, a silhouette that diverges, a concept that reads on one body and not on the other.',
    'The host checks {a}\'s makeover. Honest check — does the partner look like family or does she look like a stranger in borrowed clothes. The difference between those two is the note.',
  ]),
