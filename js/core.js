...
export const TWIST_CATALOG = [
  ...
  { id:'bb-double-veto', emoji:'💠', name:'The Double Veto', format:'big-brother',
    ...
    incompatible:['bb-secret-veto', 'bb-forced-veto', 'bb-diamond-veto'],
    incompatibleModes:[] },
  { id:'bb-secret-veto', emoji:'🕳️', name:'The Secret Veto', format:'big-brother',
    category:'twist', phase:'any',
    desc:'A second medallion exists and nobody competed for it. It is given quietly to one houseguest, and if it is used the block simply changes — a nominee comes down, a replacement goes up, and the house is never told whose hand did it. The Head of Household is not told either, so the week ends with everybody in the room having watched somebody get saved by a person who could be any of them.',
    incompatible:['bb-double-veto', 'bb-forced-veto'],
    incompatibleModes:[] },
  { id:'bb-forced-veto', emoji:'⛓️', name:'The Forced Veto', format:'big-brother',
    ...
    incompatible:['bb-double-veto', 'bb-secret-veto'],
    incompatibleModes:[] },
