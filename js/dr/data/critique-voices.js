...
export const CRITIQUE_DELIVERY = [
  deliver('blunt',
    ...
    'Praise from her, which almost never happens and everybody in the room knows it.', [
      "— and {j} does not give that note lightly. The room hears it twice: once for the words and once for who said them.",
      "— and praise from {j} is rare enough that the other judges look over. She could not talk herself out of saying it.",
      "— and {j} does not hand out compliments to be polite. The fact that she said it is the compliment.",
      "— and {j} says it flat, no warmth, same voice as always. But the words are kind. From her that is full volume.",
      "— and {j} is not smiling. She never smiles when she praises. She just says it.",
      "— and {j} would rather say nothing than lie. She said something. {a} will remember that.",
    ],
    'She says it flatly and does not soften it, and the flatness is the worst part.', [
      "— and {j} delivers it without flinching. No pause to let {a} brace.",
      "— and {j} does not wrap it. She reads it like a receipt: what happened, what it cost.",
      "— and {j} says it once, flat, and does not check whether {a} is okay. Checking would be softening.",
      "— and {j} is not cruel. She is exact. From this seat on the panel those feel the same.",
      "— and the room goes quiet. {j} said something true without caring how it landed.",
      "— and {j} says it like a diagnosis. No malice. No gentleness. The note and nothing around it.",
    ]),
  deliver('kind',
    ...
    'Warm, and warm from her is not cheap: she is delighted rather than polite.', [
      "— and {j} means it. The warmth is never performance. When it shows up the room trusts it.",
      "— and {j} lights up saying it. The other judges nod along before they realise they are nodding.",
      "— and the delight in {j}'s voice is not politeness. She wanted {a} to do well. She got what she wanted.",
      "— and {j} has been waiting all night to say something kind. She finally has a reason.",
      "— and {j} praises with her whole face. The note is not a courtesy — she is genuinely rewarded.",
      "— and {j} is beaming. A beam from the soft seat is not cheap.",
    ],
    'She finds the kindest possible way to say it, which does not make it hurt less.', [
      "— and {j} finds the gentlest angle, which makes it land harder. A pan from somebody who wanted to say something nice is its own kind of devastating.",
      "— and {j} softens the delivery without softening the note. {a} hears every word through a voice that wishes it were saying something else.",
      "— and the kindness is real. That is what makes it worse. {j} wanted {a} to do well and she is saying she did not.",
      "— and {j} wraps it in as much warmth as the truth will hold. {a} can hear the effort.",
      "— and {j} is reaching so hard for something positive that the reaching is the critique.",
      "— and {j} says it gently. The gentleness is the sharpest part.",
    ]),
];
