...
export const CASA_LINES = {
  ...
  'casa-return': [
    ...
    { id: 'cs.r.07', when: { of: 'returned', choice: 'stick', withB: true }, stage: '{a} walks in alone, and the whole fire pit exhales at once.', turns: [['a', "I'm back. Just me."], ['b', "Just you is perfect."]] },
