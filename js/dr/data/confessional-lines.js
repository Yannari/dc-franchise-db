...
export const CONFESSIONAL_TIERS = [
  ...
  tier('taken-warm', 'Somebody was good to her and she did not expect it.', +1, [
    ...
    { needs: 'design', line: '"{b} looked at my garment and instead of reading me she picked up a needle. That is the nicest thing anybody has done for me in this werkroom."' },
    ...
    { needs: 'design', line: '"She could have minded her business. She chose not to. And now I am in the confessional trying not to get emotional about somebody threading a needle for me."' },
  ...
  tier('watched-cold', 'She watched it go wrong from across the room and enjoyed '
    ...
    { needs: 'design', line: '"I was sewing. Minding my business. And then THAT happened three stations away and my whole day got better."' },
  ...
  tier('alone', 'The scene had nobody else in it. She is talking about her own '
    ...
    { needs: 'design', line: '"Four times. Unpicked this seam four times." {a} holds up the fabric. "At this point the seam is right and I am wrong."' },
    ...
    { needs: 'design', line: '"Looked at my garment and thought: who told you you could sew." {a} pauses. "Nobody told me that. I told myself that. And I was LYING."' },
    '"This is the week." {a} looks down. "You just know. The challenge drops and something in your stomach goes: girl, this is it."',
    { needs: 'design', line: '"Talking to myself at my station. Out loud. To FABRIC." {a} shakes her head. "That is where we are. Week five and I am having a conversation with tulle."' },
    ...
    { needs: 'design', line: '"I have been staring at this for forty-five minutes and it is not getting better." {a} puts down the fabric. "Which means I am making it worse. Which means I should stop. But I am not going to stop."' },
    ...
    { needs: 'design', line: '"My garment is either the best thing I have made or the worst thing I have made and I genuinely cannot tell." {a} holds it up. "That should not be a mystery to the person who MADE it."' },
  ...
  tier('runway-mine-landed', 'It went well and it was hers: the look she walked.', +1, [
    ...
    { needs: 'design', line: '"I made this in two days. TWO DAYS." {a} runs her hand down the fabric. "And it looks like it took a month. That is called talent."' },
  ...
  tier('runway-mine-missed', 'It did not go well and it was hers: the look she walked.', -1, [
    { needs: 'design', line: '"I knew on the walk out. The fabric moved wrong and I could feel it and there was nothing I could do about it up there." {a} shakes her head.' },
