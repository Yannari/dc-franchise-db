...
export const TWIST_CATALOG = [
  ...
  { id:'walk-like-an-egyptian', emoji:'🏛️', name:'Walk Like an Egyptian', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', desc:'Three-phase tribe race through an Egyptian pyramid (over or under), desert trek with reward animals (camel/goat/stick), and Nile crossing with crocodile gauntlet. Curse of the Mummified Dog persists for 3 episodes. First tribe across wins immunity.', engineType:'walk-like-an-egyptian', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','bigger-badder-brutaler','frozen-crossing','amazon-race'] },
  { id:'crazy-fun-time', emoji:'🎮', name:'Super Happy Crazy Fun Time', category:'challenge', chalSeries:'world-tour', chalStyle:'social', phase:'pre-merge', desc:'Game show challenge. Human Pinball — one rep per tribe bounces in a giant pinball machine with an animal buddy. Candy Commercial — tribes pitch, debate, and produce an ad for Chef\'s candy, judged by Chef with a hidden preference quirk.', engineType:'crazy-fun-time', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','frozen-crossing','amazon-race'] },
  { id:'frozen-crossing', emoji:'🧊', name:'Frozen Crossing', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', desc:'Two-phase arctic challenge. Ice Floe Gauntlet — all tribes cross a shared frozen river with polar bear attacks, rescues, and a cold meter. Sled Pickup Race — first finisher pulls a sled to collect teammates, with romance traps and the Bridgette Rule.', engineType:'frozen-crossing', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','amazon-race','picnic-hanging-dork'] },
  { id:'picnic-hanging-dork', emoji:'🦘', name:'Picnic at Hanging Dork', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'any', desc:'Outback emu race through four terrain segments with momentum system, then bungee into a canyon to grab sheep and shear them for wool. Post-merge: solo emu race + golden fleece hunt for individual immunity.', engineType:'picnic-hanging-dork', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','planes-trains','project-runaway'] },
  ...
  { id:'broadway-baby', emoji:'🎭', name:'Broadway Baby', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', desc:'Climb a giant Chris McLean statue, race boats through underground tunnels with an alligator chase, then bob for apples and race baby carriages to the finish. Carriage weight from Phase 1 carries forward.', engineType:'broadway-baby', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','amazon-race'] },
