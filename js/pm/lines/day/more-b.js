...
export const MORE_B = {
  ...
  'deep-chat': [
    ...
    { id: 'dc2.16', turns: [['a', "Can I be honest? I'm not sure where this is going."], ['b', "Okay. Thank you for telling me."]], beat: 'Things are quiet between them for a while after that.' },
  ...
  kiss: [
    ...
    { id: 'kiss.up4', when: { rowedToday: true }, stage: '{a} kisses {b} after the row earlier.', turns: [['b', "We're still arguing, by the way."], ['a', "I know."]] },
  ],
  ...
  'challenge-win': [
    ...
    { id: 'cw2.04', turns: [['a', "We're on a roll."], ['b', "Don't get cocky."], ['a', "Too late."]] },
...
export const MORE_MOMENTS = {
  ...
  'dump-goodbye': [
    ...
    { id: 'dg2.04', when: { withB: true }, turns: [['b', "This place won't be the same without you."], ['a', "Good. It shouldn't be."]], beat: 'They both laugh through the tears.' },
