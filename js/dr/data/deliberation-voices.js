...
export const ADVOCACY = [
  taste('challenge',
    ...
    'The work was the best in the room and the rest is detail.', [
      ...
      '{j} says it plainly: {a} did the best work in {c} tonight and the runway is not {c}. The challenge is the challenge and the garment is a garnish, and {j} is tired of watching queens get saved by a dress.',
      ...
      '{j} pushes back on {e} by naming what {a} actually did in {c}: the line that landed, the choice that worked, the moment that carried the whole number — and asks whether any of that is less real because the look was not a ten.',
    ],
  ...
  taste('runway',
    ...
    'The look is the best thing that walked and that is not nothing.', [
      ...
      '{j} leans into the runway argument and does not back down: {a}\'s look was the strongest on that stage tonight and a queen who can dress like that is a queen who understands something about this competition that the challenge alone does not measure.',
  ...
  taste('risk',
    ...
    'She went for something, and going for something is the whole job.', [
      ...
      '{j} makes the case for {a} from nerve and the case is philosophical — this is a competition about drag and drag is about risk, and {a} understood that tonight in a way that the queens {e} is defending did not.',
