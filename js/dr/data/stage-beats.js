     ...
     RuPaul has no tier: he is the one doing the introducing. */
  {
    ...
    tiers: [
      ...
      tier('guest-predator', 'villain, mastermind, schemer. The room knows what she did and she has not apologised for it. The applause has an edge.', [
        "\"And joining us tonight — {k}, {j}!\" The applause has a note in it that is not quite admiration and not quite something else, and {j} takes it with a smile that says she heard both halves and is comfortable with the ratio. She settles into the guest seat like somebody who has been watched before and did not mind it.",
        "\"Please welcome {j}, {k}!\" {j} takes the chair and the queens backstage who are listening through the curtain have just recalibrated their evening, because {j}'s season was a season people have opinions about and {j} was the reason for most of them. The panel shifts a degree. The host looks delighted.",
        "{j} is introduced as {k} and the room gives her exactly the reception she has earned, which is loud and complicated. She waves once — a small wave, contained — and crosses her legs and looks at the runway with the expression of somebody who has been on the other side of a panel and knows what the chair costs.",
        "\"Tonight we are joined by {k} — {j}!\" The host says it warmly and means it, and {j} receives the warmth and adds nothing to it, because {j} has always let the room decide how to feel about her and the room has always had feelings. She takes the seat. The panel is one degree sharper for it.",
        "\"And our guest tonight — {j}, {k}!\" {j} walks to the chair and the walk is the walk of somebody who has been introduced in rooms before and has never once adjusted herself for the applause. She sits. The host watches her sit. \"I am glad you are here,\" he says, and the gladness is real and slightly wary, which is the correct way to be glad about {j}.",
        "The host names {j} and gives the credit — {k} — and the credit lands on a room that remembers the season it came from. {j} takes the guest seat and the seat is different with her in it, not because she is trying but because she is not trying, which is the thing about {j} that made her season what it was.",
      ]),
      tier('guest-sunshine', 'hero, loyal-soldier, social-butterfly, showmancer. Loved, and the welcome is uncomplicated.', [
        "\"And joining us tonight — {k}, {j}!\" The room does not hesitate. The applause is immediate and warm and uncomplicated and {j} beams from the guest seat because the welcome is the kind of welcome a person gets when an entire audience is genuinely happy to see her. She waves at the panel and the panel waves back.",
        "\"Please welcome {j}, {k}!\" {j} takes the chair and the queens backstage can hear the warmth of the reaction through the curtain and the warmth tells them something about tonight — the guest chair is occupied by somebody the franchise loved and the franchise still loves her and the room is making sure she knows it.",
        "{j} is introduced as {k} and the cheer is the kind of cheer that has no edge in it. She sits down smiling and the smile is real and the realness is the whole reason she is here — the audience watched her season and came out the other side liking her, which on a reality show is rarer than winning.",
        "\"Tonight we are joined by {k} — {j}!\" The host grins saying it because {j} is one of the names that brings a room up, reliably, every time. {j} waves from the guest seat and mouths \"thank you\" and the mouthing is not a performance — she is a person who has been loved by a camera and has never quite gotten used to it.",
        "\"And our guest tonight — {j}, {k}!\" The welcome is a wall of sound and {j} takes it with both hands raised and a laugh that the microphones pick up. She settles into the chair and the room settles with her, because {j} is the kind of presence that makes the people around her calmer, not louder.",
        "The host names {j} and gives the credit — {k} — and the credit is greeted with the kind of noise a room makes when it remembers somebody fondly and is being given a chance to say so. {j} puts one hand on her chest. The gesture is gratitude and it is unguarded and the unguardedness is why this room sounds the way it does.",
      ]),
      tier('guest-firecracker', 'hothead, chaos-agent, wildcard. Unpredictable, and the panel is visibly braced.', [
        "\"And joining us tonight — {k}, {j}!\" The panel shifts in their seats and the shifting is involuntary because nobody on this panel knows what {j} is about to say during the critiques and that includes {j}. She takes the guest chair with the energy of somebody who has been told to behave and is considering it.",
        "\"Please welcome {j}, {k}!\" {j} drops into the guest seat with a grin that the host catches and visibly enjoys. The queens backstage have just heard the name and at least two of them are recalculating how careful they need to be on that runway, because {j}'s opinion arrives without a warning label.",
        "{j} is introduced as {k} and the room reacts with a noise that is half cheer and half the sound of a room bracing for impact. She waves once, big and loose, and leans back in the chair like she owns it already. The host watches this and the watching contains real affection and a small amount of concern.",
        "\"Tonight we are joined by {k} — {j}!\" {j} arrives in the seat the way she arrived everywhere on her season — fast, loud, and without checking whether the room was ready. The room was not ready. The room is never ready for {j}, and the host knows this, which is why he booked her.",
        "\"And our guest tonight — {j}, {k}!\" The permanent judges exchange a glance and the glance says tonight is going to be interesting, because {j}'s season was interesting in the specific way that a wildfire is interesting, and {j} was holding the match for most of it. She grins at the panel. The panel grins back, nervously.",
        "The host names {j} and gives the credit — {k} — and the room goes loud in the way it goes loud when it does not know what is about to happen but is fairly certain it will be entertaining. {j} takes the seat and the taking is not gentle. She is here. The critiques just got less predictable.",
      ]),
      tier('guest-professional', 'challenge-beast, perceptive-player. She won things. The respect is for the record.', [
        "\"And joining us tonight — {k}, {j}!\" The applause is solid and respectful and carries the particular weight of a room acknowledging a record rather than a personality. {j} nods once from the guest seat and the nod is precise and the precision is the whole reason her season went the way it went.",
        "\"Please welcome {j}, {k}!\" {j} takes the chair the way she took everything on her season — efficiently, without wasted motion. The host introduces the credit and lets the credit do the work, because {j}'s record speaks louder than a warm-up line and the room knows how to read it.",
        "{j} is introduced as {k} and the room straightens a degree. She sits in the guest seat with the posture of somebody who has been evaluated before and evaluated others and knows the difference. The panel is slightly more formal with her in it, and the formality is respect.",
        "\"Tonight we are joined by {k} — {j}!\" The host says it with genuine admiration and {j} receives it with a nod that contains the entire record in it. She does not wave. She does not beam. She sits down and looks at the runway with the eyes of somebody who knows what a strong performance costs and expects to see the cost tonight.",
        "\"And our guest tonight — {j}, {k}!\" {j} takes the seat and the seat changes. The room is more serious with her in it, not because she demands it but because her record demands it — the queens backstage who heard that credit know they are being watched by somebody who did the work and will notice if they did not.",
        "The host names {j} and gives the credit — {k} — and the credit earns the room. Not the personality, not the wave, not the smile — the credit. {j} was good at the thing this show is about and the room respects that in a way that is quieter than a cheer and heavier than applause.",
      ]),
      tier('guest-scrapper', 'underdog, goat, floater. She was not supposed to get as far as she did, and everybody remembers it.', [
        "\"And joining us tonight — {k}, {j}!\" The cheer that follows has real affection in it and a note of something else — the note of a room remembering that nobody expected {j} to last as long as she did, and that the lasting was the best part of her season. She waves from the guest seat and the wave is grateful.",
        "\"Please welcome {j}, {k}!\" {j} takes the chair and the room gives her more than she was expecting, which is how most of her season went. She settles in with the particular energy of somebody who has learned to accept a welcome she never planned for, and the acceptance is still catching up.",
        "{j} is introduced as {k} and the warmth that follows is the warmth a room gives somebody it rooted for. She sits down and looks at the stage and the looking carries the memory of a person who was on the wrong side of the odds and found her way to the right side by a margin nobody predicted, including her.",
        "\"Tonight we are joined by {k} — {j}!\" The host's tone has affection in it that goes beyond courtesy, because {j}'s season was a season where the audience chose a favourite and the favourite was the one nobody picked at the start. {j} smiles. The smile still has surprise in it and the surprise has never completely faded.",
        "\"And our guest tonight — {j}, {k}!\" {j} takes the guest seat and the queens backstage who heard the name are thinking about the season the name came from — the season where {j} was not supposed to last as long as she did and lasted longer than that. She crosses her legs and looks at the runway like somebody who has been underestimated before and enjoyed the result.",
        "The host names {j} and gives the credit — {k} — and the room cheers for the credit and then cheers again for the person, because the two are not the same thing with {j}. The credit says what happened. The cheer says how the room felt about it, which was surprised and then proud and then loudly, stubbornly on her side.",
      ]),
