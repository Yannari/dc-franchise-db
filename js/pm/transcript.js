...
export const PM_PHASE_LABEL = { arrival: 'The arrivals', 'arrival-2': 'The arrivals', coupling: 'The first coupling', debrief: 'The debrief', cinema: 'Movie Night',
...
export function phasesOf(row) {
  ...
  const ORDER = { arrival: -2, 'arrival-2': -1.5, coupling: -1, debrief: -0.5, morning: 0, day: 1, challenge: 1.5, event: 2, evening: 3, cinema: 3.5 };
