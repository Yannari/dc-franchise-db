...
export const CRITIQUE_CHALLENGE = [
  ...
  chal('music-video',
    ...
    tier('praise', 'She understood the camera and gave the edit everything it needed.', [
      "{j} tells {a} the director said she was the one who understood what the camera wanted. She found the lens, she played the part at the right scale, and the edit has more of her than anybody because she gave it more to use.",
      "\"The director LOVED you,\" {j} says. \"He said you took direction, you found the camera every time, and you gave the edit so much material that they could have cut a solo video from your footage alone.\"",
      "{j} says {a} understood something the other queens did not — a video is not a stage. She played smaller, she played smarter, and the lens rewarded her for it. The director confirmed it.",
      "The critique is about camera instinct: {j} tells {a} she gave the edit everything — the angles, the energy, the takes. The director said she was the easiest queen to shoot and the hardest to cut around.",
      "{j} points at {a} and says the director\'s report was clear: {a} showed up knowing her part, took every note, found the camera on every setup, and gave {o} through a lens — which is harder than giving it on a stage.",
      "\"You are a camera queen,\" {j} tells {a}. \"The director said so and the tape proves it. You found the light, you found the lens, and you gave {o} in every single setup.\"",
    ]),
    tier('fault', 'She was unfindable in the frame, or the day cost her more than the part was worth.', [
      "{j} tells {a} the director could not find her. A full day on set and {a} was the queen the camera had to chase instead of the queen who found it, and {p} showed up every time the lens got close.",
      "\"The director said you were lost,\" {j} says. \"Lost in the part, lost on the set, and {p} was all the camera found when it finally landed on you.\"",
      "{j} says {a} did not know how to play for a camera. She played for a stage — too big, too broad — and the lens picked up {p} instead of the performance the director asked for.",
      "The critique is about the day itself: {j} tells {a} the director\'s report was not kind. She took more takes than anyone, she could not find the camera, and {p} was visible in the footage they DID manage to use.",
      "{j} looks at {a} and says a music video is about the edit, and the edit had nothing from her. The director gave her notes, she did not take them, and {p} was the only thing consistent across her setups.",
      "\"The tape does not lie,\" {j} says. \"And the tape says you were unfindable. The director looked for you and all he found was {p}. That is not a music video performance.\"",
    ])),
  chal('rusical',
