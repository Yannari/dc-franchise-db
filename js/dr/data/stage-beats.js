...
export const STAGE_BEATS = [
  ...
  // ══ THE LIP SYNC, BEAT BY BEAT ═══════════════════════════════════════
  {
    ...
    note: 'Two queens stand before the host. The last-chance speech and the song. '
      + 'On a for-the-win night the speech is different — nobody is going home and '
      + 'the emphasis is on the WIN rather than survival.',
    tierBy: 'stakes',
    tiers: [
      tier('intro', 'This is your last chance to impress me.', [
      ...
      tier('win', 'For the win. Nobody is going home — the song is a reward.', [
        "\"Ladies, prior to tonight you were asked to prepare a lip sync performance of {s}.\" He grins because this is the good version of the speech. \"This is a lip sync for the WIN. Good luck, and don\'t fuck it up.\" The track drops and both queens take their marks, and the energy on the stage is ambition rather than fear.",
        "\"The time has come for you to lip sync for the WIN.\" He lets the word sit. \"The song tonight is {s}. Now show me what you\'ve got.\" Both queens adjust their stances, the music comes up, and the room shifts from a verdict into a contest.",
        "\"{s}.\" He names the song and both queens nod because they know it. \"Now, I want to see everything. The stage is yours. Make mama proud.\" The track fills the room and the energy is celebration, not survival.",
        "\"Two queens stand before me, and tonight nobody is going home.\" The host lets the relief land and then replaces it. \"But only one of you can win. The song is {s}. Lip sync for the WIN. Don\'t fuck it up.\" The music starts.",
        "\"Nobody goes home tonight, but somebody wins.\" He lets the room hear the difference. \"The song is {s}. Show me you want it. Show me you DESERVE it.\" He steps back and the track drops while both queens are still taking their marks.",
        "\"Ladies, this is a lip sync for the WIN, and the song is {s}.\" He pauses long enough for both of them to hear the title. \"The time has come. Don\'t fuck it up.\" The music comes up under his voice and both queens take their positions.",
      ]),
    ],
  },
  {
  ...
  },
  {
    ...
    tiers: [
      ...
      tier('for-the-win', 'The top two lip synced for the win. The host crowns the winner.', [
        '"Ladies, I have made my decision." The host looks at both queens. "Condragulations — you\'re a winner, baby." One queen screams. The other claps, because she knows what she just watched and she knows it earned the win.',
        '"That was a LIP SYNC." The host grins wide. "But there can only be one winner, and I have made my decision. Condragulations, my dear — you are the winner of this week\'s challenge." The winner puts both hands over her mouth and the sound she makes is not a word.',
        '"Ladies, you both turned it OUT tonight." The host means it. "But I have made my decision. Condragulations — you\'re a winner, baby." The winner takes the deepest breath of the night and the other queen hugs her before the sentence is finished.',
        '"I have made my decision." He takes his time. "Condragulations, you are the winner of tonight\'s lip sync for the win." The winning queen clasps her hands under her chin and the tears start before she can stop them.',
        '"Now THAT is what I am talking about." The host surveys both queens and lets the room settle. "I have made my decision. Condragulations — you\'re a winner, baby." The winner\'s face breaks open and the other queen reaches over and squeezes her arm.',
        '"Ladies, that was everything I wanted to see and more." A beat. "Condragulations — you\'re a winner, baby. You have won this week\'s challenge." The winner drops into a curtsy that is half gratitude and half disbelief.',
      ]),
  ...
  // Legacy night it is for the power to send somebody home.
  {
    ...
    tiers: [
      ...
      tier('win', 'The top two, for the win. Nobody is going home.', [
        '"{a}, {b} — tonight, nobody is going home." He lets the sentence breathe. "Instead, you two will lip sync — not for your life — but for the WIN."',
        '"{a}, {b}. You are the top two queens of the week, and that means you have earned the right to lip sync for the WIN." He grins and the grin says the rest.',
        '"Now, {a} and {b}, I said it before and I will say it again — you two are the cream of the crop this week. And for that, you get to lip sync for the WIN."',
        '"{a}, {b}, condragulations. You were the best two queens tonight. But only one of you can win, so you will lip sync — for the WIN."',
        '"{a}. {b}." He looks at each of them. "You are the best on this stage tonight, and I need to see who is THE best. You will lip sync for the WIN."',
        '"This is not a lip sync for your life, ladies — this is a lip sync for the WIN." He says it like the distinction matters, because it does.',
      ]),
