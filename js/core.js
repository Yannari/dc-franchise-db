...
export const TWIST_CATALOG = [
  ...
  { id:'super-hero-ld', emoji:'🦸', name:'Super Hero-ld', category:'challenge', chalSeries:'action', phase:'post-merge', desc:'Post-merge superhero challenge. Costume design contest judged by Chris, then a timed obstacle course (trampoline, rescue, meteor dodge). Villain sabotage by Pythonicus throughout.', engineType:'super-hero-ld', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified'] },
