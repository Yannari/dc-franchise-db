...
import * as vpDrWerkMod from './vp-dr/werk.js';
import * as vpDrArrivalsMod from './vp-dr/arrivals.js';
import * as vpDrChalMod from './vp-dr/challenge.js';
import * as vpDrStageMod from './vp-dr/stage.js';
import * as vpDrResultsMod from './vp-dr/results.js';
...
// The run loop's villa branch, and the module that sets window._pmRunnable.
// Same rule as the two above: importing it IS the wiring.
...
const extractedModules = [
  ...
  castUiMod, castRoomMod, studioMod, quickSetupMod, trArrivalMod, trConclaveMod, trRoundTableMod, trColdOpenMod, trHouseStatusMod, trMissionMod, trArmouryMod, trRecruitmentMod, trEndgameMod, trCastleDayMod, trSelectionMod, trSuspicionMod, trConfessionalsMod, trDebugMod, trRunMod, drRunMod, pmRunMod, drJudgesUiMod, vpDrRevealMod, vpDrScreensMod, vpDrChartMod, vpDrWerkMod, vpDrArrivalsMod, vpDrChalMod, vpDrStageMod, vpDrResultsMod, bbRunMod, rivalsMod, runUiMod, vpScreensMod, vpFinaleMod, vpUiMod, vpCoachesMod,
  savestateMod,
  statsExportMod,
  audioMod,
  recapMod,
