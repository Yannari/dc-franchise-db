...
export const MORE_D = {
  ...
  'heart-rate': [
    ...
    { id: 'hr3.12', when: { coupled: false, taken: true }, stage: "{a}'s number climbs for {b}, and keeps climbing. {pa} watches it happen.", turns: [['a', "I think it's broken."]], beat: '{pa} is fairly sure it is not broken.' },
