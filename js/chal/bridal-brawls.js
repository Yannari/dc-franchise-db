...
function portrait(name, size = 42) {
  ...
  return `<img src="${slAv}" alt="${name}" style="width:${size}px;height:${size}px;border-radius:4px;object-fit:cover;flex-shrink:0;background:#c8b888" onerror="this.style.display='none'">`;
}
