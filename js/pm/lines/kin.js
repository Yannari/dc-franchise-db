...
export const KIN_LINES = {
  ...
  'ex-reveal': [
    ...
    { id: 'xr.s2', when: { of: 'spark' }, turns: [['a', "Everyone, this is my ex."], ['b', "Hi. I'm the ex."]], beat: "They're both trying not to smile." },
  ...
  date: [
    ...
    { id: 'xd.02', when: { exes: true }, turns: [['a', "This is the first time we've sat across a table since we broke up."], ['b', "Don't make it a thing."], ['a', "It's already a thing."]], beat: "They're both laughing now." },
  ...
  'casa-miss': [
    ...
    { id: 'cm.w1', when: { of: 'worries' }, stage: "{a} hasn't touched breakfast.", turns: [['a', "What do you think {about} is doing right now?"], ['b', "Probably sitting there missing you."], ['a', "Or probably not."]] },
  ...
  'kin-vet': [
    ...
    { id: 'kv.d1', when: { of: 'doubt' }, stage: '{a} takes {b} to one side, away from {c}.', turns: [['a', "What are your intentions with {c}?"], ['b', "My intentions?"], ['a', "You heard me."]], beat: "{b} doesn't have a good answer ready." },
  ...
  'kin-protect': [
    ...
    { id: 'kp.f3', when: { of: 'family' }, stage: '{a} finds {b} by the pool.', turns: [['a', "If you hurt {c}, you deal with me. I'm just saying."]], beat: "{b} doesn't argue." },
    ...
    { id: 'kp.fr2', when: { of: 'friends' }, stage: "{a} pulls {b} aside, and doesn't bother with a smile.", turns: [['a', "{c} deserves better than watching that."], ['b', "Watching what?"], ['a', "You and {about}. Don't pretend."]] },
  ...
  'ex-awkward': [
    ...
    { id: 'ea.s3', when: { of: 'spark' }, stage: "The whole villa notices {a} and {b} laughing together, the way exes do when they aren't quite over it.", turns: [['a', "Old times."], ['b', "Old times."]] },
  ...
  'ex-jealous': [
    { id: 'ej.01', stage: '{a} watches {b} and {c} on the daybed.', turns: [['a', "I don't care. Honestly. I don't."]], beat: '{a} keeps watching.' },
    { id: 'ej.02', turns: [['a', "{c}? Really? That's not even {b.posAdj} type."]] },
    { id: 'ej.03', stage: '{a} goes very quiet when {b} kisses {c} across the room.', turns: [['a', "Good for them."]], beat: "{a} doesn't sound happy for them." },
  ],
  'kin-goodbye': [
