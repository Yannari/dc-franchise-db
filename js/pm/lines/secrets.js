...
export const SECRET_LINES = {
  ...
  'apology-rejected': [
    ...
    { id: 'aj.f.02', when: { of: 'final' }, turns: [['b', "We're done. We've been done for days. You need to let it go."], ['a', "Okay. I'm sorry. For all of it."]] },
  ...
  photos: [
    ...
    { id: 'ph.k.02', when: { of: 'kiss' }, stage: 'The photo is of {b} kissing somebody new.', turns: [['a', "You said nothing happened."], ['b', "I said nothing serious happened."]], beat: '{a} laughs, and it sounds like crying.' },
