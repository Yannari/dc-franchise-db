...
export const MORE_D = {
  ...
  'heart-rate': [
    ...
    { id: 'hr3.08', when: { coupled: false, taken: true }, stage: "{a}'s heart rate jumps for {b}, and {b} looks just as surprised.", turns: [['a', "That's not what it looks like."]], beat: 'Everyone can see it on the screen.' },
    ...
    { id: 'hr3.14', when: { coupled: false, taken: true }, stage: "{a}'s monitor barely moves for {pa}, and jumps for {b}.", turns: [['a', "I'm just really comfortable with you. That's a good thing!"]], beat: "{pa} doesn't look convinced." },
    { id: 'hr3.15', when: { coupled: false, taken: true }, stage: "Everyone is watching {pa} when {a}'s reading for {b} comes up.", turns: [['a', "Nobody say anything."]], beat: 'Everyone looks at {pa}.' },
    { id: 'hr3.16', when: { coupled: false, taken: true }, stage: "{b} walks past {a}, and {a}'s heart rate doubles.", turns: [['a', "I'd had a lot of coffee."]], beat: 'Nobody believes {a}, especially {pa}.' },
  ...
  families: [
    ...
    { id: 'fm2.12', when: { verdict: 'good' }, stage: "{a}'s family have one question for {b}, and it's about the wedding.", turns: [['b', "We haven't even left the villa yet."], ['a', "That's never stopped them."]] },
  ...
  notes: [
    ...
    { id: 'nt3.02', when: { guessed: false }, stage: "The note about {b} says {b} can't make up {b.posAdj} mind about anyone.", turns: [['b', "That's rich. Who wrote that?"]], beat: 'Nobody owns up. {a} keeps quiet.' },
    ...
    { id: 'nt3.06', when: { guessed: true }, stage: 'The note about {b} is read out, and {b} turns straight round to {a}.', turns: [['b', "Really?"], ['a', "It wasn't me."]], beat: 'It was {a}.' },
  ],
