...
5. TWISTS AS DRAMA — for every twist in the summary (schoolyard pick, JOURNEY, advantage found/hidden idol hunt, Rescue Island arrival, swap, mutiny), describe the SCENE it becomes and the conflict/emotion to mine. A twist is never a checkbox — a schoolyard draft is a scene of captains snubbing people and the sting of being picked last; a JOURNEY is a full scene of the chosen players pulled from camp, trekking to a remote place, and facing the gamble there (risk your vote for an advantage? take the safe nothing?) — NEVER reduce a journey to "they came back with nothing." If players lost votes or gained advantages on a journey, we SEE how.
...
- HONOR EVERY TWIST PRESENT IN THE SUMMARY. If the summary contains a SCHOOLYARD PICK / captain draft, you MUST dramatize the draft on screen — captains picking players one at a time, the sting of being picked last, the unpicked player sent to exile — do NOT skip it and simply have Chris announce finished tribes. A JOURNEY is likewise a SCENE, not a footnote: show the chosen players leaving camp, the trek to the remote spot, and the gamble they face there (risk your vote for an advantage, or take the safe nothing) — if a player lost a vote or won an advantage on a journey, we SEE it happen; never just have them "come back with nothing" in a confessional. The same applies to tribe swaps, mutinies, returns from Rescue Island, and advantage/idol plays: if it's in the summary, it happens on screen.
`;
