...
export const TWIST_CATALOG = [
  ...
  { id:'ambassadors',     emoji:'🤝', name:'Ambassadors',          category:'elim',       phase:'any',       desc:'Schedule on the merge episode. Each tribe names an ambassador. They meet and must agree on one elimination — or one ambassador draws the wrong rock.',  engineType:'ambassadors', incompatible:['slasher-night','sudden-death','triple-dog-dare'] },
