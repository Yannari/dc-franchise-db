...
export const CROWNING_BEATS = [
  ...
  // ══ THE OTHER ONE ════════════════════════════════════════════════════
  {
    ...
    tiers: [tier('runnerup', 'Second, in front of everybody.', [
      "{a} hears the other name and her face does the thing it was always going to do, which is crack for exactly one second before she puts it back together. The crack is real and the putting-it-back-together is real and both of them happen in front of a room full of people she has lived with for weeks. She turns to the winner and the hug is immediate and full and does not let go for a beat longer than it needs to, and when it does she steps back and her face is composed and the composure is costing her something visible.",
