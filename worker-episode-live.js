...
⛔ NO NONSENSE "CLEVER" SENTENCES. Never personify objects or body parts ("my leg and I had a meeting", "the fire has an understanding with me", "sleep ghosted me"), never use backwards logic ("the rope lost me"), never "[X] emotionally/spiritually", never poetic descriptions of people ("Fiore is a knife with lip gloss"), never fortune-cookie one-liners ("nervous people slip more"), never joke tags stapled to a serious confessional. Say what literally happened: "my leg hurts", "I fell", "it's freezing", "she's dangerous — she'll smile and then cut you."
