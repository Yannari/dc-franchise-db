...
const SEEN_LINES = {
  unseen: [
    ...
    'It happened in a corner of the afternoon nobody was watching, and {who} came back to the others as though {they} had never left.',
    'Whatever {who} found, {who} found it unobserved — which is the only way anybody would want to find it.',
  ],
  few: [
    'One or two people clocked {who} slipping away, and rather fewer worked out why.',
    'A couple of heads turned when {who} came back. That was the whole of the audience.',
    '{who} was seen — barely, and by the only people paying attention — and the rest of the castle has no idea.',
    'It was not quite private. A pair of eyes followed {who} back to the others and said nothing about it.',
  ],
  some: [
    ...
    '{who} did not get away with it quietly. A handful of people know exactly what {they} came back with.',
  ...
  most: [
    ...
    'There was no hiding this one: everybody stopped working to watch {who} come back.',
