...
export const TWIST_CATALOG = [
  ...
  { id:'bb-forced-veto', emoji:'⛓️', name:'The Forced Veto', format:'big-brother',
    ...
    incompatibleModes:[] },
  { id:'bb-veto-redraw', emoji:'🎲', name:'Veto Player Redraw', format:'big-brother',
    category:'advantages', phase:'any',
    desc:'The chips come back out of the bag. Every houseguest who drew their way into the veto competition loses that seat and the draw is run again from scratch — the Head of Household and the nominees still play by right, because nothing has ever taken that away, so what gets re-rolled is exactly the part that was luck. Somebody who spent two days being promised things because they were standing in that competition can be standing in the crowd ten minutes later, and the person who takes their place did nothing at all to earn it.',
    incompatible:['bb-veto-replacement'],
    incompatibleModes:[] },
  { id:'bb-veto-replacement', emoji:'🔁', name:'Veto Replacement', format:'big-brother',
    category:'advantages', phase:'any',
    desc:'One seat in the veto competition changes hands. A houseguest who drew a chip is taken out of the field and a houseguest who drew nothing is put into it, in front of everybody, with no competition and no reason given. The block has spent the afternoon working out how to talk to the people who were playing, and now has until the competition starts to work out somebody else.',
    incompatible:['bb-veto-redraw'],
    incompatibleModes:[] },
