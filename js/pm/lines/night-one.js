...
export const NIGHT_ONE = {
  'arrival-chat': [
    ...
    { id: 'ac.s.01', when: { of: 'same-type' }, turns: [['b', "Wait. That's my type too."], ['a', "No."], ['b', "Yes."], ['a', "Well. May the best one win, I suppose."]], beat: 'They both laugh, a bit nervously.' },
    ...
    { id: 'ac.s.04', when: { of: 'same-type' }, turns: [['a', "I've got a feeling we're going to want the same person."], ['b', "Then we talk about it. No drama."], ['a', "No drama. Deal."]], beat: 'They shake on it. Neither of them looks sure.' },
    ...
    { id: 'ac.x.04', when: { of: 'clash' }, turns: [['b', "Are you always this full-on?"], ['a', "Are you always this quiet?"], ['b', "Only around people I'm not sure about."]], beat: "It's a slightly frosty first five minutes." },
  ...
  debrief: [
    ...
    { id: 'db.u.06', when: { of: 'unsure', taken: true }, turns: [['a', "I think {pa} is more into me than I am into {pa}."], ['b', "That's a tricky one."], ['a', "I don't want to hurt anyone on the first night."]], beat: "{b} doesn't have an answer for that." },
    ...
    { id: 'db.r.03', when: { of: 'rather', taken: true, cast: 3 }, turns: [['a', "{pa} is lovely. But when {c} walked in, I forgot how to breathe."], ['b', "You need to be careful with that."], ['a', "I know. I'm going to be."]], beat: "{b} doesn't look convinced." },
    ...
    { id: 'db.y.02', when: { of: 'rather-yours', bTaken: true }, turns: [['b', "Who would you have picked, if you could?"], ['a', "Honestly? {pb}."], ['b', "Wow. Okay. Thanks for telling me, I suppose."]], beat: "{b} goes to find {pb}, and doesn't come back to the conversation." },
    ...
    { id: 'db.y.04', when: { of: 'rather-yours', bTaken: true }, turns: [['b', "You've been staring at {pb} since the fire pit."], ['a', "I haven't."], ['b', "You have. And I'm right here."]], beat: "It's the first frosty moment of the series." },
    { id: 'db.y.05', when: { of: 'rather-yours', bTaken: true }, turns: [['a', "I don't want to make things weird, but I think {pb} is gorgeous."], ['b', "Things are weird now."], ['a', "Sorry."]], beat: "{b} doesn't say another word to {a} tonight." },
  ],
  'bombshell-text': [
  ...
  entrance: [
    ...
    { id: 'eb.07', when: { of: 'bombshell' }, stage: "For a moment there's only the sound of a suitcase on the steps.", turns: [['narrator', "Every islander in this villa is thinking the same thing. Please don't be my partner's type."], ['a', "Evening, everyone. I'm {a}."]] },
    ...
    { id: 'eb.10', when: { of: 'bombshell', persona: 'wallflower' }, stage: '{a} appears at the top of the steps and freezes for a second.', turns: [['narrator', "The quiet ones, the villa always says. Watch the quiet ones."], ['a', "Hi. I'm {a}. That's… that's it. That's my speech."]], beat: 'Everyone laughs.' },
  ],
  'bombshell-react': [
    { id: 'br.s.01', when: { of: 'stunned', cast: 2 }, turns: [['a', "Oh my God."]], beat: "{a} can't stop looking at {b}." },
    ...
    { id: 'br.p.01', when: { of: 'stunned', cast: 3 }, turns: [['a', "Wow."], ['c', "Wow what?"], ['a', "Nothing. It's just a nice evening."]], beat: "{c} isn't buying it." },
    ...
    { id: 'br.w.01', when: { of: 'worried' }, turns: [['a', "Why is {b} staring at {c} like that?"]], beat: "{a} crosses {a.posAdj} arms and doesn't uncross them." },
    ...
    { id: 'br.w.05', when: { of: 'worried' }, turns: [['a', "I'm fine. I'm totally fine. {b} can look at whoever {b} wants."]], beat: '{a} is clearly upset.' },
    ...
    { id: 'br.u.03', when: { of: 'unbothered' }, turns: [['a', "Everyone calm down. It's one person."]], beat: 'Everyone keeps staring anyway.' },
