...
export const MORE_E = {
  'ballot-reveal': [
    ...
    { id: 'br3.03', turns: [['a', "This isn't personal. I'm voting for {b} to go."]], beat: "{b} nods, but doesn't look up." },
    ...
    { id: 'br3.07', turns: [['a', "I'm going with my gut, and my gut says {b}."]], beat: "There's a sharp intake of breath from the benches." },
  ...
  loyalty: [
    ...
    { id: 'ly3.02', when: { justMet: true }, turns: [['b', "Do you want to have a chat?"], ['a', "Maybe with everyone. Not on our own, not tonight."]], beat: "{b} laughs it off, and doesn't ask again." },
  ...
  gossip: [
    ...
    { id: 'gs3.05', when: { knows: true }, stage: "{a} sits down next to {b}, and doesn't smile.", turns: [['a', "Can I be honest with you about something? You're not going to like it."], ['b', "Is it about {c}?"], ['a', "It's about {c}."]] },
  ],
  'lie-react': [
