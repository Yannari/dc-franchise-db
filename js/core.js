...
export const TWIST_CATALOG = [
  ...
  { id:'pm-got-the-receipts', emoji:'\u{1F9FE}', name:"Got the Receipts", format:'perfect-match',
    category:'games', phase:'any', engineType:'pm-got-the-receipts', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'receipts' },
    ...
    incompatible:['pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-look-whos-talking', emoji:'\u{1F5E3}', name:"Look Who's Talking", format:'perfect-match',
    category:'games', phase:'any', engineType:'pm-look-whos-talking', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'look-who' },
    ...
    incompatible:['pm-got-the-receipts','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-sauciest-snogger', emoji:'\u{1F48B}', name:"Sauciest Snogger", format:'perfect-match',
    category:'games', phase:'any', engineType:'pm-sauciest-snogger', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'snogger' },
    ...
    incompatible:['pm-got-the-receipts','pm-look-whos-talking','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-couple-goals', emoji:'\u{1F3AF}', name:"Couple Goals", format:'perfect-match',
    category:'games', phase:'any', engineType:'pm-couple-goals', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'couple-goals' },
    ...
    incompatible:['pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-knowing-me', emoji:'\u{1F4DD}', name:"Knowing Me, Knowing You", format:'perfect-match',
    category:'games', phase:'any', engineType:'pm-knowing-me', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'knowing-me' },
    ...
    incompatible:['pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-talent-show', emoji:'\u{1F3A4}', name:"The Talent Show", format:'perfect-match',
    category:'games', phase:'any', engineType:'pm-talent-show', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'talent' },
    ...
    incompatible:['pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-baby-dolls', emoji:'\u{1F37C}', name:"The Baby Dolls", format:'perfect-match',
    category:'games', phase:'any', engineType:'pm-baby-dolls', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'baby' },
    ...
    incompatible:['pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-couple-of-sorts', emoji:'\u{1F3C5}', name:"Couple of Sorts", format:'perfect-match',
    category:'games', phase:'any', engineType:'pm-couple-of-sorts', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'couple-of-sorts' },
    ...
    incompatible:['pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-grafties'] },
  { id:'pm-grafties', emoji:'\u{1F396}', name:"The Grafties", format:'perfect-match',
    category:'games', phase:'any', engineType:'pm-grafties', pmOn:['public-vote'], pmApply:{ challenge:'grafties' },
    ...
    incompatible:['pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts'] },
