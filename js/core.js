...
export const TWIST_CATALOG = [
  ...
  { id:'camp-castaways', emoji:'🏝️', name:'Camp Castaways', category:'challenge', phase:'post-merge', desc:'Flash flood scatters the camp. Survival scoring across 5 phases (flood, scattered, night, regrouping, storming camp). Mr. Coconut breakdown. Chris surveillance with playback callbacks. Best survivor wins individual immunity.', engineType:'camp-castaways', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','are-we-there-yeti','monster-cash'] },
