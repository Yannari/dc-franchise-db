...
const extractedModules = [
  playersMod, bondsMod, alliancesMod, votingMod, adaptationMod, socialStatusMod, vpKitMod,
  ...
  castUiMod, castRoomMod, quickSetupMod, runUiMod, vpScreensMod, vpFinaleMod, vpUiMod,
  savestateMod,
  statsExportMod,
  audioMod,
  recapMod,
