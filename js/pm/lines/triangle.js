...
export const TRIANGLE_LINES = {
  ...
  'triangle-rivals': [
    ...
    { id: 'tr.s.02', when: { of: 'size-up' }, stage: 'In the kitchen, a very polite conversation.', turns: [['b', "No hard feelings, whatever happens with {c}."], ['a', "No hard feelings."]], beat: 'There are plenty of hard feelings.' },
  ...
  'triangle-ultimatum': [
    ...
    { id: 'tu.n.01', when: { of: 'not-yet' }, turns: [['a', "Me or {c}? I need to know tonight."], ['b', "I can't do that. Not tonight."], ['a', "Then when?"], ['b', "I don't know."]], beat: '{a} laughs, but it is not a happy laugh.' },
  ...
  'triangle-choice': [
    ...
    { id: 'tx.p.02', when: { of: 'pick' }, turns: [['c', "So that's it, then."], ['a', "I'm sorry. It was always going to hurt someone."]], beat: '{b} squeezes {a.posAdj} hand. {c} does not look back.' },
    { id: 'tx.p.03', when: { of: 'pick' }, stage: 'Straight after the recoupling.', turns: [['c', "I thought it was me."], ['a', "So did I, for a while."]], beat: 'It is the worst thing {a} could have said, and {a} knows it.' },
