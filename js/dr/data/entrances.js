...
export const ARRIVAL_INTROS = {
  ...
  dry: [
    ...
    "{a}, {years} years in. I work as {job} during the week and I do this at the weekend and neither job pays enough.",
    ...
    "I'm {a}, {years} years in drag. That's the short version and the long version is the same.",
  ],
  warm: [
