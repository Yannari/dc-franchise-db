...
export const HUT = {
  honest: [
    ...
    { id: 'hut.chat.h5', when: K('chat', { ...B, gap: true }), turns: [['a', "I asked {b} where we are, and I still don't really know. I'm trying not to let it get to me."]] },
    ...
    { id: 'hut.pull.h5', when: K('pull', { ...B, role: 1 }), turns: [['a', "I didn't see that coming from {b}. I don't hate it, either."]] },
    ...
    { id: 'hut.pull.h10', when: K('pull', { ...B, role: 1 }), turns: [['a', "{b} wants to get to know me. I'm going to let {b}, and see what happens."]] },
    ...
    { id: 'hut.casa.h5', when: { kind: 'casa-return', role: 1 }, turns: [['a', "I've just walked into a villa where half the people hate me already. Brilliant."]] },
    { id: 'hut.casa.h6', when: { kind: 'casa-return', role: 0, choice: 'stick' }, turns: [['a', "I didn't do anything at Casa I'd be ashamed of. I can look my partner in the eye."]] },
    ...
    { id: 'hut.ritual.h2', when: { kind: 'movie-night' }, turns: [['a', "I didn't think anyone would ever see that. Now everyone has."]] },
  ...
  'two-faced': [
    ...
    { id: 'hut.casa.t1', when: { kind: 'casa-return', role: 0, choice: 'stick' }, turns: [['a', "What happens at Casa stays at Casa. That's what everyone says, isn't it?"]] },
  ],
};
