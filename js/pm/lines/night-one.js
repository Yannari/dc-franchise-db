...
export const NIGHT_ONE = {
  'arrival-chat': [
    ...
    { id: 'ac.l.05', when: { of: 'looking' }, turns: [['a', "What's the one thing someone would have to be for you?"], ['b', "Kind. Everything else I can work with."], ['a', "Kind. Okay. I'm writing that down in my head."]] },
    ...
    { id: 'ac.c.04', when: { of: 'compliment' }, turns: [['a', "You look so calm."], ['b', "I'm not calm at all. I'm just good at faces."], ['a', "Teach me."]] },
    ...
    { id: 'ac.t.04', when: { of: 'type' }, turns: [['a', "I'm hoping someone walks in and I just know."], ['b', "Does that ever actually happen?"], ['a', "Once. It went badly. I'm trying again."]] },
  ...
  'bombshell-guess': [
    ...
    { id: 'bg.s.05', when: { coupled: false }, turns: [['a', "I'm not saying I've got my hopes up."], ['b', "You've put lipstick on in the last thirty seconds."], ['a', "I'm not saying I haven't, either."]] },
  ...
  'bombshell-react': [
    ...
    { id: 'br.p.01', when: { of: 'stunned', cast: 3 }, turns: [['a', "Wow."], ['c', "Wow what?"], ['a', "Nothing. Wow, nice evening."]], beat: '{c} is not buying it.' },
