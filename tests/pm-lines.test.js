...
describe('the pools are well-formed', () => {
  ...
  it('a scene only names the people its kind casts', () => {
    ...
    const CAST = { comedy: 1, gossip: 3, 'head-turned': 1, 'jealous-sulk': 1, overthinking: 1,
      ...
      'blow-slip': 2, 'blow-dare': 3, 'lip-watch': 3, 'tower-q': 3, 'course-run': 1, 'course-pick': 3, 'course-win': 2, 'sports-win': 4, 'sports-sore': 2, headline: 4, 'lady-luck-pick': 3, 'step-reveal': 4, 'step-choose': 4, 'date-text': 3, 'date-picked': 3, 'date-back': 3 };
