...
export const RULES_LINES = {
  'challenge-rules': [
    ...
    rules('truth-dare',
      "Here's how it works. Everybody plays. One at a time, each islander draws a card, and chooses: truth, or dare.",
      "A truth is a question you have to answer in front of the whole villa, your partner included. A dare is a kiss, and you choose who. Nobody wins. That is not the point."),
    rules('heart-rate',
