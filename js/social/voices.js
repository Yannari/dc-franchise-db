...
export const TRAIT_TAKES = {
  ...
  deadpan: {
    ...
    nomination: [
      ({ s, w }) => `${s} is ${w.onDanger}. ${s} will be fine or ${s} will not. Those are the options.`,
  ...
  theatrical: {
    ...
    nomination: [
      ({ s, w }) => `${s} ${w.onDanger} — ${s}! — and we are all meant to sit here as though this is a normal Thursday.`,
  ...
  blunt: {
    ...
    nomination: [
      ...
      ({ s, w }) => `${s} is not ${w.pawn}. ${s} is a target with better manners applied to it.`,
  ...
  warm: {
    ...
    nomination: [
      ...
      ({ s, w }) => `It is lonely being the name, in a ${w.home} full of people. That is the part nobody warns you about.`,
  ...
  nervous: {
    ...
    nomination: [
      ({ s }) => `Oh, that is going to sit badly. Not the ceremony — the way nobody looked at ${s} afterwards.`,
      ({ s }) => `I would be spiralling. ${s} is not spiralling, apparently, which I find slightly alarming.`,
      ({ s }) => `The word they are using for ${s} is doing a lot of damage in there and I do not think anybody means it unkindly, which is the problem.`,
  ...
  streetwise: {
    ...
    nomination: [
      ({ s, w }) => `${s} is ${w.onDanger}. Fight or do not. Nobody is coming.`,
