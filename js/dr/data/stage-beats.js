  ...
  },
  {
    ...
    tiers: [
      tier('held', 'The pause before she says a name.', [
        "The music stops and the host does not speak. She looks at both queens and the silence in the room is the silence of twelve people trying not to breathe, because whoever moves first — whoever clears her throat or adjusts her wig — is the person who looks like she knows what is about to happen, and neither of them does.",
        "The host holds the room for what feels like a full minute and is probably four seconds. Both queens are standing in the light and neither of them is moving and the host is not speaking and the only sound in the building is the air conditioning and somebody in the back shifting their weight.",
        "She takes her time. The host looks at the queens and then at the panel and then back at the queens and the looking is the beat — the room needs to feel the weight of what is about to happen, and the weight is in the waiting, and the host knows that better than anyone on that stage.",
        "The host does not rush. Both queens are standing in front of her and the moment between the song ending and the verdict beginning is the moment the show exists for, and the host gives it exactly as much time as it needs, which is more time than either queen would choose.",
        "The silence after the lip sync is louder than the song. Both queens are breathing hard and the host is standing in front of them with an expression that gives nothing away, and the room is holding itself together because the next sentence out of that mouth changes somebody's life.",
        "She waits. The host has been doing this long enough to know that the pause before the name is more important than the name itself, because the pause is where every person in the room — both queens, the panel, the safe queens watching from the back — feels the same thing at the same time.",
        "Both queens are on the stage and the host is between them and nobody is speaking. The lip sync is over and the verdict is coming and the distance between those two things — the performance and the sentence — is the distance the host is holding open right now, and she is holding it open on purpose.",
        "The host stands with both queens and lets the room settle into the quiet that follows a lip sync. It is not a comfortable quiet. It is the quiet of a room that knows what is about to happen and is watching the host decide how long to make them wait for it.",
        "Neither queen looks at the other. They are both looking at the host, and the host is looking at both of them with an expression that is equal parts compassion and authority, and the pause is the pause that means the decision has already been made and the host is choosing when to say it.",
        "The host takes a breath. Both queens see her take the breath and both of them try to read the breath and neither of them can, because the breath is not the tell — the tell is after the breath, in the name, and the name has not been said yet.",
      ]),
    ],
  },
  {
    ...
    tiers: [
      tier('shantay', 'She stays, and she hears it first.', [
        "\"{a}, shantay you stay.\" The words land and {a} presses both hands to her chest and the relief rewrites her entire body — the shoulders drop, the jaw unclenches, and the queen who was bracing for the worst gets the best, and the getting is visible from every seat in the room.",
        "The host says {a}'s name and follows it with the two words that mean she lives to fight another week, and {a} mouths \"thank you\" three times before the sound comes out, because the first two times her voice is not available to her.",
        "\"{a} — shantay, you stay.\" {a} takes a breath that fills her from the floor up. She is staying. She fought for it and she has it and the fight is over and the relief arrives all at once, like a wave that was being held back by a wall that just came down.",
        "\"Shantay, you stay.\" {a} hears it and does not react for a full second, because the brain needs a moment to believe what the ears just reported. Then the face breaks open and the composure she held through the entire lip sync is gone in an instant.",
        "The host looks at {a} and says the name, and the name is followed by \"shantay you stay\", and {a} presses her hands together and bows her head and the bow is not a performance — it is a queen who just heard she gets to keep doing this for at least one more week.",
        "\"Shantay, you stay,\" the host says, and {a} exhales everything she has been holding since the music started. The exhale takes the fear with it and what is left is a queen standing on a stage she almost had to leave, and the almost is what makes the standing feel like something she earned.",
        "\"{a}.\" The host says the name and lets it sit. \"Shantay, you stay.\" {a} nods and the nod is steady and the steadiness is the shell around the relief, because showing everything on this stage is not what {a} does, and the queens who know her see the relief in the nod anyway.",
        "The shantay goes to {a} and {a} receives it with the grace of somebody who was ready for either answer. Her back straightens. She says \"thank you\" once, directly to the host, and the gratitude is quiet and enormous and she walks to the back of the stage with the posture of a person who knows exactly what she just survived.",
        "\"Shantay, you stay.\" {a} closes her eyes when she hears it. She keeps them closed for two full seconds and what happens behind them is between her and the moment, and when she opens them the room is still there and she is still in it and the realisation hits again.",
        "\"{a}, shantay you stay.\" The words arrive and {a} puts one hand on her own sternum as if checking that her heart is still inside her body. It is. She is staying. She watches the other queen for a moment and the watching is complicated, because surviving means somebody else did not.",
      ]),
    ],
  },
  {
    ...
    tiers: [
      tier('sashay', 'She goes, and the host tells her so herself.', [
        "The host turns to {a} and says something kind and specific — something about her time here, something about what she brought to this room — and then the sentence that follows is \"now, sashay away,\" and {a} nods and takes the sentence with dignity because the dignity is the last thing she can choose.",
        "\"{a}, you have shown us so much of who you are,\" the host says, and {a} listens with the face of a person who already knows what the next sentence is. \"Now — sashay away.\" {a} stands tall and turns and the turning is the bravest thing she does all night.",
        "The host addresses {a} directly and the directness is warm and the warmth makes it harder, not easier. She talks about what {a} brought to the competition and what {a} gave the room and then she says the words, and the words are final, and {a} receives them standing up.",
        "\"Now, sashay away.\" The host says it gently, and {a} takes a breath and nods and the nod is the last thing she gives the panel before she turns toward the queens at the back of the stage. The walk starts. The walk is steady. Everything she is feeling is behind the steadiness.",
        "The host thanks {a} for being here — not in the generic way but in the specific way, naming a moment from the season, naming something {a} did that nobody else could — and then closes with the sentence that sends her home, and the sentence is kind in the way that only the host can make it kind.",
        "\"{a}.\" The host says the name and {a} looks at her and the look is the look of somebody who is about to hear something she has been dreading since the lip sync ended. \"Now, sashay away.\" {a} mouths \"thank you\" and it is genuine and the genuineness makes the room ache.",
        "The host holds {a}'s gaze and says the words that mean she is leaving this stage and not coming back. {a} takes them without flinching. She has been a queen on this stage and she will be a queen walking off it and the walking off is the last piece of her time here and she gives it everything.",
        "\"You are an incredible queen,\" the host says to {a}, and {a} blinks once and the blink is the crack in the composure. \"Now — sashay away.\" {a} straightens her back and walks, and the walk is as good as anything she did on the runway, because this is her last one and she knows it.",
        "The host tells {a} that the competition will miss her, and the telling is personal — not a speech, not a benediction, but one person talking to another about what it meant to have her here. And then the host says the words, and {a} leaves, and the leaving is as composed as the queen who is doing it.",
        "\"Sashay away.\" The host delivers it after a pause that is full of everything she wanted to say and a sentence that is all she actually says, and {a} takes it and walks and the silence behind her is the room holding its breath until the door closes.",
      ]),
    ],
  },
  {
