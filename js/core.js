...
export const TWIST_CATALOG = [
  ...
  { id:'producer-swap',    emoji:'🎬', name:'Producer Swap',        category:'team',       phase:'pre-merge',  desc:'Production override — NOT random. Chris reassigns a player YOU pick to a tribe YOU pick (optionally swapping someone back the other way). Configure the move on the episode tag.', engineType:'producer-swap' },
  ...
  { id:'no-challenge',     emoji:'⛔', name:'No Challenge',          category:'immunity',   phase:'post-merge', desc:'No immunity challenge tonight — nobody wins safety. Camp life and scheming play out, then a normal tribal council where everyone is vulnerable.', engineType:'no-challenge', incompatible:['no-tribal','reward-twist-challenge','sudden-death','slasher-night','triple-dog-dare','are-we-there-yeti','chain-of-command','tied-destinies','shared-immunity','penalty-vote','disadvantage-vote'] },
  { id:'disadvantage-vote', emoji:'⚖️', name:'The Disadvantage Vote', category:'immunity',   phase:'post-merge', desc:"Before the immunity challenge, the field gathers at the elimination area and votes to hand ONE player a disadvantage in that night's challenge. Each player pleads their case — why not them, or who should get it — and a damaging reveal can swing the room. The most-voted player runs the challenge with a ~35% handicap that can cost them immunity. Works with any challenge (twist or generic).", engineType:'disadvantage-vote', incompatible:['no-challenge','reward-twist-challenge','sudden-death','slasher-night','triple-dog-dare','are-we-there-yeti','tied-destinies','shared-immunity'] },
  // Elimination
  ...
  { id:'sudden-death',     emoji:'💀', name:'Sudden Death',         category:'challenge',  chalStyle:'endurance', phase:'post-merge', desc:'No tribal council. Last place in the challenge is auto-eliminated on the spot. Pure performance — no vote, no strategy, no safety net.',  engineType:'sudden-death',    incompatible:['slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','lucky-hunt','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'slasher-night',    emoji:'🔪', name:'Slasher Night',        category:'challenge',  chalSeries:'island', chalStyle:'hunt', phase:'post-merge', desc:'A slasher hunts the tribe. Players are picked off round by round. Last one standing wins immunity. Lowest scorer is eliminated. No tribal council.',  engineType:'slasher-night',   incompatible:['sudden-death','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','lucky-hunt','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'triple-dog-dare',  emoji:'🎯', name:'Triple Dog Dare',      category:'challenge',  chalSeries:'island', chalStyle:'social', phase:'post-merge', desc:'Eliminated players dare the tribe. Accept to earn freebies, redirect to spend them. Run out of freebies and fail a dare? You\'re out. No tribal council.', engineType:'triple-dog-dare', incompatible:['sudden-death','slasher-night','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','lucky-hunt','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'say-uncle', emoji:'💪', name:'Say Uncle', category:'challenge', chalSeries:'island', chalStyle:'endurance', phase:'post-merge', desc:'The Dungeon of Misfortune. 4-phase torture endurance: The Wheel, The Gauntlet, The Rack, The Final Sentence. Survive 10 seconds or say uncle. Dominate to pick the next victim — but if they pass, YOU go to the pillory. Last one standing wins immunity.', engineType:'say-uncle', incompatible:['sudden-death','slasher-night','triple-dog-dare','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','lucky-hunt','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'operation-classified', emoji:'🕶️', name:'Operation: Classified', category:'challenge', chalSeries:'action', chalStyle:'puzzle', phase:'post-merge', desc:'Post-merge spy mission. Face scans, laser vault, wiretap blackmail, and bomb defusal. One immunity winner by default; true ties grant double immunity, near-ties resolve by sudden defusal.', engineType:'operation-classified', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','houston','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'super-hero-ld', emoji:'🦸', name:'Super Hero-ld', category:'challenge', chalSeries:'action', chalStyle:'adventure', phase:'post-merge', desc:'Post-merge superhero challenge. Costume contest judged by Chris, then a city-wide battle royale with type-matchup fights, zone assignments, and between-round drama. Survivors face Mega Pythonicus boss fight — final blow wins immunity.', engineType:'super-hero-ld', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified','princess-pride','get-a-clue','houston','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'haunted-house', emoji:'🏚️', name:'Haunted House', category:'challenge', chalSeries:'dc4', chalStyle:'adventure', phase:'post-merge', desc:'Post-merge escape challenge. Three rooms of the carnival\'s haunted mansion: a floating-candle Library with a combination lock, a split into cursed rooms for three keys, and a final showdown with the Ordinary Girl Doll boss. Players are knocked out, locked in, and fall through the floor — the first to cut the rope and escape wins immunity.', engineType:'haunted-house', incompatible:['say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','picnic-hanging-dork','slap-slap-revolution','broadway-baby','viking-sour','planes-trains','bridal-brawls','great-fake-out','amazon-race','night-at-museum','truth-or-shark','rock-the-dock','tropical-takedown','midnight-manhunt','bigger-badder-brutaler','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','truth-or-dare-train','a-maze-ing-grip','poles-apart','hells-kitchen','trust-challenge','basic-straining','monster-cash','mine-over-matter','treasure-island','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','greeces-pieces','hangar-black','african-lying-safari','rapa-phooey','drumheller','ice-ice-baby','project-runaway','finders-creepers','backstabbers-ahoy'] },
  { id:'princess-pride', emoji:'👑', name:'The Princess Pride', category:'challenge', chalSeries:'action', chalStyle:'adventure', phase:'post-merge', desc:'Fairy tale quest challenge. Glass slipper crowns a Princess/Prince. Knights compete through Enchanted Forest, Troll Bridge, Dragon\'s Lair, and Tower Rescue. Princess gives advantages and has one save. Top knight duels the Princess for immunity.', engineType:'princess-pride', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified','super-hero-ld','get-a-clue','houston','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'get-a-clue', emoji:'🔍', name:'Get a Clue', category:'challenge', chalSeries:'action', chalStyle:'puzzle', phase:'post-merge', desc:'Murder mystery challenge. DNA collection via traps & hunts, murder investigation on a train with blackout events, and a Danganronpa-style trial arc with presentation, cross-examination, and deduction. Courtroom vote winner gets immunity; perfect solver can earn a second immunity.', engineType:'get-a-clue', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified','super-hero-ld','princess-pride','rock-n-rule','houston','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'crouching-courtney', emoji:'🥋', name:'Way of the Warrior', category:'challenge', chalSeries:'action', chalStyle:'chaos', phase:'post-merge', desc:'Kung fu challenge. Training montage with fighter/trainer pairs, robot fight bracket with joystick controls, and mountain climb with water cup balance, cooperation temptation, and Sasquatchanakwa boss. Mole becomes saboteur if active.', engineType:'crouching-courtney', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','houston','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'houston', emoji:'🚀', name:'Houston, We Have a Problem', category:'challenge', chalSeries:'action', chalStyle:'adventure', phase:'post-merge', desc:'Space station challenge. Zero-G clue hunt for pod components, RED ALERT crisis with timed pod repair, re-entry shakedown (vomit = eliminated), and station sprint obstacle race. Mole sabotages from the shadows. First to escape the fake Earth station wins immunity.', engineType:'houston', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'top-dog', emoji:'🐾', name:'Top Dog', category:'challenge', chalSeries:'action', chalStyle:'adventure', phase:'post-merge', desc:'Animal buddy challenge. Train a randomly assigned animal (12 types, danger 1-5) for a circus trick performance judged by Chris and Chef, then race through the forest with your animal navigating. Head start from Phase 1. Mole gets GPS advantage and sabotages morale.', engineType:'top-dog', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'walk-like-an-egyptian', emoji:'🏛️', name:'Walk Like an Egyptian', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', desc:'Three-phase tribe race through an Egyptian pyramid (over or under), desert trek with reward animals (camel/goat/stick), and Nile crossing with crocodile gauntlet. Curse of the Mummified Dog persists for 3 episodes. First tribe across wins immunity.', engineType:'walk-like-an-egyptian', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','bigger-badder-brutaler','frozen-crossing','amazon-race','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'crazy-fun-time', emoji:'🎮', name:'Super Happy Crazy Fun Time', category:'challenge', chalSeries:'world-tour', chalStyle:'social', phase:'pre-merge', desc:'Game show challenge. Human Pinball — one rep per tribe bounces in a giant pinball machine with an animal buddy. Candy Commercial — tribes pitch, debate, and produce an ad for Chef\'s candy, judged by Chef with a hidden preference quirk.', engineType:'crazy-fun-time', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','frozen-crossing','amazon-race','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'frozen-crossing', emoji:'🧊', name:'Frozen Crossing', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', desc:'Two-phase arctic challenge. Ice Floe Gauntlet — all tribes cross a shared frozen river with polar bear attacks, rescues, and a cold meter. Sled Pickup Race — first finisher pulls a sled to collect teammates, with romance traps and the Bridgette Rule.', engineType:'frozen-crossing', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','amazon-race','picnic-hanging-dork','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'picnic-hanging-dork', emoji:'🦘', name:'Picnic at Hanging Dork', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'any', desc:'Outback emu race through four terrain segments with momentum system, then bungee into a canyon to grab sheep and shear them for wool. Post-merge: solo emu race + golden fleece hunt for individual immunity.', engineType:'picnic-hanging-dork', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'slap-slap-revolution', emoji:'👋', name:'Slap Slap Revolution', category:'challenge',
    chalSeries:'world-tour', chalStyle:'physical', phase:'pre-merge', minTribes:2,
    desc:'Grind meat into a giant sausage, bobsled down a mountain, then 1v1 slap-dance fights on electrified DDR platforms. Last tribe standing avoids tribal.',
    engineType:'slap-slap-revolution',
    incompatible:['cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','phobia-factor','brunch-of-disgustingness','lucky-hunt','say-uncle','triple-dog-dare','sudden-death','slasher-night','monster-cash','operation-classified','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','full-metal-drama','oceans-heist','million-bucks-bc','sports-marathon','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','broadway-baby','bigger-badder-brutaler','truth-or-shark','amazon-race','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'broadway-baby', emoji:'🎭', name:'Broadway Baby', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', desc:'Climb a giant Chris McLean statue, race boats through underground tunnels with an alligator chase, then bob for apples and race baby carriages to the finish. Carriage weight from Phase 1 carries forward.', engineType:'broadway-baby', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','amazon-race','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'viking-sour', emoji:'⚔️', name:'Viking Sour', category:'challenge',
    chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', minTribes:2,
    desc:'Decipher shredded blueprints to build longships, launch and sail through icy waters, then naval battle with cannons. Capture the flag or sink the enemy.',
    engineType:'viking-sour',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'planes-trains', emoji:'✈️', name:'Planes, Trains & Hot Air Mobiles', category:'challenge',
    chalSeries:'world-tour', chalStyle:'adventure', phase:'post-merge',
    desc:'No-rules multi-vehicle race. Scavenge vehicles from wreckage, race overland with sabotage and confrontations, cross the sea through minefields, sprint to the beach. Vehicle HP degrades from damage — destruction forces improvisation.',
    engineType:'planes-trains',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','bridal-brawls','great-fake-out','african-lying-safari','rapa-phooey','drumheller','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'bridal-brawls', emoji:'💒', name:'Bridal Brawls', category:'challenge',
    chalSeries:'world-tour', chalStyle:'social', phase:'post-merge',
    desc:'Casino slot pairs players. Blindfolded obstacle course, tightrope carry over shark waterfall, customs trivia. Winning pair both get immunity.',
    engineType:'bridal-brawls',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','great-fake-out','planes-trains','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'great-fake-out', emoji:'🏯', name:'The Great Fake-Out', category:'challenge',
    chalSeries:'world-tour', chalStyle:'adventure', phase:'post-merge',
    desc:'Vehicle scramble + fortress wall gauntlet race (last place cut) + gross food eating gauntlet. Ink wash scroll aesthetic.',
    engineType:'great-fake-out',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','bridal-brawls','planes-trains','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'amazon-race', emoji:'🌿', name:'The Am-AH-Zon Race', category:'challenge',
    chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', minTribes:2,
    desc:'Jungle expedition race. Zipline crossing, multi-segment jungle trek with hazards, guardian tribe encounter, and treasure hunt in ancient ruins.',
    engineType:'amazon-race',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','night-at-museum','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'night-at-museum', emoji:'🏛️', name:'Night at the Museum', category:'challenge',
    chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', minTribes:2,
    desc:'Museum heist. Navigate security, search galleries for statue pieces, assemble under animal siege.',
    engineType:'night-at-museum',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','amazon-race','slap-slap-revolution','broadway-baby','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','cultural-reset','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'truth-or-shark', emoji:'🦈', name:'Truth or Shark', category:'challenge',
    chalSeries:'revenge', chalStyle:'social', phase:'pre-merge',
    desc:'Game show trivia — confess embarrassing truths or face the punishment wheel. Fatigue stacks punish serial refusers. Last tribe standing wins.',
    engineType:'truth-or-shark',
    incompatible:['phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','say-uncle','brunch-of-disgustingness','triple-dog-dare','sudden-death','slasher-night','lucky-hunt','hide-and-be-sneaky','off-the-chain','super-hero-ld','princess-pride','monster-cash','walk-like-an-egyptian','bigger-badder-brutaler','camp-castaways','alien-egg','crazytown','chefshank','one-flu','masters-of-disasters','full-metal-drama','million-bucks-bc','operation-classified','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','tri-armed-triathlon','beach-blanket-bogus','oceans-heist','sports-marathon','wawanakwa-gone-wild','are-we-there-yeti','cultural-reset','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'rock-the-dock', emoji:'⚓', name:'Rock the Dock', category:'challenge', chalSeries:'world-tour', chalStyle:'physical', phase:'pre-merge', minTribes:2, engineType:'rock-the-dock', desc:'Coastal relay. Swim to shore, elect a captain, race through a 4-leg dock relay.', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','bigger-badder-brutaler','truth-or-shark','tropical-takedown','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'tropical-takedown', emoji:'🌴', name:'Tropical Takedown', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', minTribes:2, engineType:'tropical-takedown', desc:'Cliff dive tag-relay into shark-infested waters, retrieve golden chains, then race longboards down a volcanic slope.', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','bigger-badder-brutaler','truth-or-shark','rock-the-dock','midnight-manhunt','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'midnight-manhunt', emoji:'🏮', name:'Midnight Manhunt', category:'challenge', chalSeries:'world-tour', chalStyle:'hunt', phase:'pre-merge', minTribes:2, engineType:'midnight-manhunt', desc:'Victorian manhunt. Strip guards for clues, survive the torture rack, then hunt the Ripper through gaslit streets with corgi allies.', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','bigger-badder-brutaler','truth-or-shark','rock-the-dock','tropical-takedown','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'bigger-badder-brutaler', emoji:'💣', name:'Bigger! Badder! Brutal-er!', category:'challenge', chalSeries:'revenge', chalStyle:'chaos', phase:'pre-merge', desc:'ROTI totem race. Each tribe debates a method (trampoline, saw-climb, or human stack), retrieves an axe, cuts the bomb-rigged totem before detonation, then rides the totem down a waterfall and slope to camp. Winners pick a cabin — losers\' totem destroys it. Wildlife sabotage, bomb explosions, and method-war blame.', engineType:'bigger-badder-brutaler', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','first-impressions','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'rock-n-rule', emoji:'🤘', name:'Rock n\' Rule', category:'challenge', chalSeries:'action', chalStyle:'chaos', phase:'post-merge', desc:'Rock-and-roll challenge. Guitar Hero performance with electrocution, red carpet gauntlet with style vs damage scoring, and hotel room trashing with inventory destruction and berserker mode. Phase winners get cascading advantages. Cumulative score determines immunity.', engineType:'rock-n-rule', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified','super-hero-ld','princess-pride','get-a-clue','houston','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'brunch-of-disgustingness', emoji:'🤮', name:'Brunch of Disgustingness', category:'challenge', chalSeries:'island', chalStyle:'social', preferMergeEp:true, phase:'post-merge', desc:'Boys vs girls eating challenge at merge. 9 courses of disgusting food — every member must eat or the team loses the course. Chain vomiting. Eat-off tiebreaker. Losing team goes to tribal.', engineType:'brunch-of-disgustingness', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'phobia-factor', emoji:'😱', name:'Phobia Factor', category:'challenge', chalSeries:'island', chalStyle:'social', phase:'pre-merge', desc:'Each player faces their worst fear. Tribe with the best completion rate wins immunity. Worst tribe goes to tribal. Triple points clutch for losing tribe.', engineType:'phobia-factor', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'cliff-dive', emoji:'🏔️', name:'Cliff Dive', category:'challenge', chalSeries:'island', chalStyle:'physical', phase:'pre-merge', desc:'Three-phase tribe challenge: cliff jump (willingness), crate haul (physical), hot tub build (mental). Chickens get blame on losing tribe.', engineType:'cliff-dive', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'awake-a-thon', emoji:'😴', name:'Awake-A-Thon', category:'challenge', chalSeries:'island', chalStyle:'endurance', phase:'pre-merge', desc:'Three-phase endurance: 20km run, feast trap, then stay awake. Last team standing wins. Mid-challenge social events fire between dropouts.', engineType:'awake-a-thon', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'dodgebrawl', emoji:'🏐', name:'Dodgebrawl', category:'challenge', chalSeries:'island', chalStyle:'chaos', phase:'pre-merge', desc:'Multi-round dodgeball. All tribes on the court — first to 3 wins immunity. Highlights, heroics, and blame.', engineType:'dodgebrawl', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'talent-show', emoji:'🎭', name:'Talent Show', category:'challenge', chalSeries:'island', chalStyle:'social', phase:'pre-merge', desc:'Camp talent show. Each tribe auditions, captain picks 3 acts. Chef scores 0-9. Disasters, clutch moments, and villain sabotage.', engineType:'talent-show', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'sucky-outdoors', emoji:'🏕️', name:'The Sucky Outdoors', category:'challenge', chalSeries:'island', chalStyle:'endurance', phase:'pre-merge', desc:'Overnight survival in the woods. Five phases of drama. First tribe back in the morning wins. Getting lost can cost your team everything.', engineType:'sucky-outdoors', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'up-the-creek', emoji:'🛶', name:'Up the Creek', category:'challenge', chalSeries:'island', chalStyle:'adventure', phase:'pre-merge', desc:'Canoe race to Boney Island and back. Pick your partner. Portage through danger. Build a fire. Race home. Partner chemistry matters.', engineType:'up-the-creek', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'paintball-hunt', emoji:'🎯', name:'Paintball Deer Hunter', category:'challenge', chalSeries:'island', chalStyle:'hunt', phase:'pre-merge', desc:'Paintball hunt. Half your tribe are hunters, half are deer. Hunters track opposing deer. Last tribe with unpainted deer wins. Social chaos guaranteed.', engineType:'paintball-hunt', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'truth-or-dare-train', emoji:'🚂', name:'Truth or Dare Train', category:'challenge', chalSeries:'dc4', chalStyle:'social', phase:'pre-merge', desc:'Teams race cart-to-cart to the front of a moving train. Every camper takes one Truth or Dare hot seat. Complete it to advance; refuse and your team eats a 5-minute penalty. Fastest team wins immunity.', engineType:'truth-or-dare-train', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'a-maze-ing-grip', emoji:'🌽', name:'A-Maze-ing Grip', category:'challenge', chalSeries:'dc4', chalStyle:'endurance', phase:'pre-merge', desc:'Corn-maze net challenge. Each team commits 2 holders suspending their net plus a designated dunker; the rest raid the maze for coconuts and sink them into a rival net to strain their holders. Holders can swap. Last net standing wins immunity.', engineType:'a-maze-ing-grip', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','poles-apart','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'poles-apart', emoji:'🏖️', name:'Poles Apart', category:'challenge', chalSeries:'dc4', chalStyle:'physical', phase:'pre-merge', desc:'Beach tug-of-war melee, best of three rounds. Each team plants 3 holders gripping poles; the rest swarm the rival holders and drag them across the center line. Down all their holders to win the round. Gang-ups, resist moves, and sit-outs. First to two rounds wins immunity.', engineType:'poles-apart', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'tusks-and-ladders', emoji:'🐘', name:'Tusks and Ladders', category:'challenge', chalSeries:'dc4', chalStyle:'chaos', phase:'pre-merge',
    desc:"DC4 big-top team challenge. Every ladder piece is tethered to one furious elephant — grab them off its trunk, tail, and back, assemble a ladder, then send two climbers up to a cannon to fire at the rival team's flag. First flag hit wins immunity. The elephant runs a rage meter (Calm→Rampage); schemers can smack it into charging the rival team, heroes rescue thrown teammates and lead it into getting its tusks stuck, and a host tranquilizer ends the mayhem before the cannon duel.",
    engineType:'tusks-and-ladders', minTribes:2,
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','poles-apart','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'killer-clown', emoji:'🤡', name:'Night of the Killer Clown', category:'challenge', chalSeries:'dc4', chalStyle:'adventure', phase:'post-merge',
    desc:"DC4 night-forest immunity race. Each player is handed a backpack with a map and a dart gun — but half the guns are empty and half the bags hold only the darts, so nobody can fend off the stalking animatronic clown alone. Choose the river route or the mountain route, barter or steal for ammo, grab a flag from the dark and be the first back to camp. The clown drags off the exposed (a heavy time penalty) and can only be stunned for five minutes by a loaded gun. First flag home wins immunity.",
    engineType:'killer-clown',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','poles-apart','tusks-and-ladders','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'bumper-car-bash', emoji:'🎡', name:'Bumper Car Bash', category:'challenge', chalSeries:'dc4', chalStyle:'physical', phase:'post-merge',
    desc:"DC4 neon-tent immunity challenge. Every camper drives a bumper car and scores by ramming rivals — 1 point for a rear hit, 2 for a T-bone, 3 for a surprise head-on ambush (nulled if both hit dead-on at once). Alliances set up combos and block for each other, a stalled car can cost you the game, leaders get denied at the line, and allies betray when only one can win. First driver to 20 points wins immunity.",
    engineType:'bumper-car-bash',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','poles-apart','tusks-and-ladders','killer-clown','say-cheese','wheel-of-misfortune'] },
  { id:'say-cheese', emoji:'📸', name:'Say Cheese', category:'challenge', chalSeries:'dc4', chalStyle:'adventure', phase:'post-merge',
    desc:"DC4 dawn drop-tower immunity challenge. Bungee off the tower and take a selfie with zero fear on your face — first perfect fearless shot wins immunity, the rest face the jury. Three heights (bottom/halfway/top) escalate the fear; the Disadvantage Vote target is forced to the TOP. Nerve holds composure, snap times a clean shot. Sabotage (rock at the phone, rope-yank, distraction, or a psychological jab about a real showmance/eliminated ally) ruins a shot — break a phone and it's one warning, do it twice and you're disqualified.",
    engineType:'say-cheese',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','poles-apart','tusks-and-ladders','killer-clown','bumper-car-bash','wheel-of-misfortune'] },
  { id:'wheel-of-misfortune', emoji:'🎡', name:'Wheel of Misfortune', category:'challenge', chalSeries:'dc4', chalStyle:'physical', phase:'post-merge',
    desc:"DC4 night-carnival PAIR immunity challenge run in three phases. Ferris Wheel Dodgeball — one partner rides a wheel cart and pelts the enemy targets while their grounded partner dodges; three hits frees the partner. Blindfold Search — the freed partner hunts three balls blind on the rider's shouted directions while rivals swipe and trust cracks. Tilt-Maze Puzzle — both partners tilt a maze to roll three balls home; leadership gets handed off and a player can tip the winning ball out of bounds to gift a rival or showmance the win. First pair to finish — both partners — wins immunity. Pairs are the Tied Destinies pairs when that twist is live.",
    engineType:'wheel-of-misfortune',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','poles-apart','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'hells-kitchen', emoji:'🔥', name:"Hell's Kitchen", category:'challenge', chalSeries:'island', chalStyle:'chaos', phase:'pre-merge', desc:'Cooking challenge. Head chef leads the team through 3 courses. Kitchen chaos, sabotage, and food fights determine who serves the best meal.', engineType:'hells-kitchen', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'trust-challenge', emoji:'🤝', name:"Who Can You Trust?", category:'challenge', chalSeries:'island', chalStyle:'social', phase:'pre-merge', desc:'Three trust tests. Chris picks the worst pairs. Rock climb, fugu cooking, blind challenges. Trust is earned or destroyed.', engineType:'trust-challenge', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'basic-straining', emoji:'🎖️', name:'Basic Straining', category:'challenge', chalSeries:'island', chalStyle:'physical', phase:'any', desc:"Chef's military boot camp. 6 phases of escalating challenges. Players quit or get eliminated. Last team standing (pre-merge) or last player standing (post-merge) wins.", engineType:'basic-straining', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','lucky-hunt','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'monster-cash', emoji:'🦎', name:'Monster Cash', category:'challenge', chalSeries:'action', chalStyle:'hunt', phase:'any', desc:"Chef's animatronic monster prowls the film lot. Players are captured round by round as the monster escalates from clumsy to unstoppable. Last one standing wins. Pre-merge: tribe with best survival average wins immunity. Post-merge: lowest scorer auto-eliminated.", engineType:'monster-cash', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','brunch-of-disgustingness','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'mine-over-matter', emoji:'⛏️', name:'Mine Over Matter', category:'challenge', chalSeries:'revenge', chalStyle:'adventure', phase:'any', desc:"Descend into a radioactive mine, dig out your gems under a Geiger countdown, then run the cart tunnels past mutant gophers and giant scorpions and scramble out before detonation — and pray your bag doesn't have a hole at the exit. Light economy, mystery backpack bombs, and a chance to throw the challenge for a friend. Pre-merge: tribe with richest gem haul wins immunity. Post-merge: highest haul wins individual immunity.", engineType:'mine-over-matter', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','truth-or-shark','bigger-badder-brutaler','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','rock-the-dock','midnight-manhunt','greeces-pieces','hangar-black','viking-sour','bridal-brawls','great-fake-out','african-lying-safari','picnic-hanging-dork','tropical-takedown','rapa-phooey','drumheller','planes-trains','ice-ice-baby','project-runaway','finders-creepers','backstabbers-ahoy','reward-twist-challenge','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'treasure-island', emoji:'🏴‍☠️', name:'The Treasure Island of Dr. McLean', category:'challenge', chalSeries:'revenge', chalStyle:'adventure', phase:'any', desc:"Pair off (bond-driven) for an underwater treasure dive: cut the lifeboats loose and paddle to the checkpoint, then one dives for Dr. McLean's lost chest while the other guides from the surface with a chart. Down in the sunken cave the chest is fought over hand-to-hand — until a diver gets wedged and runs out of air, forcing the leading crew to choose between the win and a rescue. CPR on the deck, keepsakes, and giftable immunity. Pre-merge: tribe with the richest average crew haul wins. Post-merge: the winning crew earns immunity for both.", engineType:'treasure-island', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','truth-or-shark','bigger-badder-brutaler','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','rock-the-dock','midnight-manhunt','greeces-pieces','hangar-black','viking-sour','bridal-brawls','great-fake-out','african-lying-safari','picnic-hanging-dork','tropical-takedown','rapa-phooey','drumheller','planes-trains','ice-ice-baby','project-runaway','finders-creepers','backstabbers-ahoy','mine-over-matter','reward-twist-challenge','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'alien-egg', emoji:'👽', name:'Alien Resurr-eggtion', category:'challenge', chalSeries:'action', chalStyle:'hunt', phase:'any', desc:"Chef dons the Mama Alien costume and hunts players with a paintball slime gun across a sci-fi film set. Find alien eggs, deliver them to the extraction zone. Get slimed and you're out. Pre-merge: tribe with most eggs wins. Post-merge: most eggs delivered wins immunity.", engineType:'alien-egg', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','brunch-of-disgustingness','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'beach-blanket-bogus', emoji:'🏖️', name:'Beach Blanket Bogus', category:'challenge', chalSeries:'action', chalStyle:'chaos', phase:'pre-merge', desc:'Three beach challenges on the film lot: surfboard endurance over a shark pool, sandcastle construction with scavenge and sabotage, and a dance-off tiebreaker. Retro beach movie vibes.', engineType:'beach-blanket-bogus', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'crazytown', emoji:'🤠', name:'3:10 to Crazytown', category:'challenge', chalSeries:'action', chalStyle:'chaos', phase:'pre-merge', desc:'Three Western challenges on the film lot: 100-foot horse dive with chicken cascade, Mexican standoff water gun elimination, and cattle roundup roping. Spaghetti Western showdown vibes.', engineType:'crazytown', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','beach-blanket-bogus','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'chefshank', emoji:'⛓️', name:'The Chefshank Redemption', category:'challenge', chalSeries:'action', chalStyle:'chaos', phase:'pre-merge', desc:'Prison-themed two-part challenge. Phase 1: teams cook disgusting prison food for an enemy victim — round-by-round eating duel. Winner gets the Golden Shovel. Phase 2: obstacle course + tunnel dig race. Shovel team digs faster.', engineType:'chefshank', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','beach-blanket-bogus','crazytown','one-flu','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'one-flu', emoji:'🏥', name:'One Flu Over the Cuckoos', category:'challenge', chalSeries:'action', chalStyle:'puzzle', phase:'pre-merge', desc:'Medical-themed two-part challenge. Phase 1: study session sleep deprivation + medical quiz. Phase 2: disease outbreak assembly simulation. Teams diagnose, treat, and survive a fake epidemic.', engineType:'one-flu', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','beach-blanket-bogus','crazytown','chefshank','masters-of-disasters','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'masters-of-disasters', emoji:'🌋', name:'Masters of Disasters', category:'challenge', chalSeries:'action', chalStyle:'chaos', phase:'pre-merge', desc:'Disaster-themed two-part challenge. Phase 1: earthquake marathon endurance. Phase 2: escape a sinking submarine. Survive the chaos.', engineType:'masters-of-disasters', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','beach-blanket-bogus','crazytown','chefshank','one-flu','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'oceans-heist', emoji:'🏦', name:"Ocean's Eight—or Nine", category:'challenge', chalSeries:'action', chalStyle:'chaos', phase:'pre-merge', desc:'Bank heist three-part challenge. Phase 1: crack the vault to free teammate. Phase 2: security gauntlet heist. Phase 3: build and race getaway go-karts.', engineType:'oceans-heist', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','full-metal-drama','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'million-bucks-bc', emoji:'🦴', name:'One Million Bucks, B.C.', category:'challenge', chalSeries:'action', chalStyle:'physical', phase:'pre-merge', desc:'Prehistoric two-part challenge. Phase 1: fire-making with rocks (cheating possible). Phase 2: bone battle on columns over a tar pit — 3-way free-for-all, last standing wins.', engineType:'million-bucks-bc', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','full-metal-drama','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'sports-marathon', emoji:'🏆', name:'Sports Marathon', category:'challenge', chalSeries:'action', chalStyle:'physical', phase:'pre-merge', desc:'Sports-themed challenge. Obstacle course seeding → 4 sports (boxing, badminton, wrestling, slam dunk) → cheerleading tiebreaker. Each sport uses different stats.', engineType:'sports-marathon', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','full-metal-drama','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'full-metal-drama', emoji:'⚔️', name:'Full Metal Drama', category:'challenge', chalSeries:'action', chalStyle:'physical', phase:'pre-merge', desc:'War-themed two-part challenge. Phase 1: paratroop plane jump landing. Phase 2: paint bomb combat and capture the flag. Tactical chaos on the film lot battlefield.', engineType:'full-metal-drama', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'x-treme-torture', emoji:'🤸', name:'X-Treme Torture', category:'challenge', chalSeries:'island', chalStyle:'physical', phase:'pre-merge', desc:'Three extreme sport events: Sofa Bed Skydiving, Rodeo Moose Riding, and Mud Skiing. One player per tribe per event. Injuries, sabotage, and social chaos. Opposing tribe drives your skier.', engineType:'x-treme-torture', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'lucky-hunt', emoji:'🗝️', name:'Lucky Hunt', category:'challenge', chalSeries:'island', chalStyle:'hunt', phase:'post-merge', desc:'Post-merge scavenger hunt. Every player searches for a key. One chest hides immunity — the others hold food, traps, and surprises. Hunt, help, steal, and scheme.', engineType:'lucky-hunt', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','wawanakwa-gone-wild','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'hide-and-be-sneaky', emoji:'🔫', name:'Hide and Be Sneaky', category:'challenge', chalSeries:'island', chalStyle:'hunt', phase:'post-merge', desc:'Post-merge hide-and-seek. Chef hunts with a water gun. Stay hidden, escape to home base, or betray allies. 1-2 immunity winners. Betrayal mechanics, archetype-driven loyalty decisions.', engineType:'hide-and-be-sneaky', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','off-the-chain','wawanakwa-gone-wild','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'off-the-chain', emoji:'🚲', name:"That's Off the Chain!", category:'challenge', chalSeries:'island', chalStyle:'chaos', phase:'post-merge', desc:'Post-merge bike-building and racing. Build a bike, swap with a rival, two-part race with obstacle gauntlet. Bikes fall apart mid-race. Sabotage, rivalry, and demolition derby chaos.', engineType:'off-the-chain', incompatible:['slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','wawanakwa-gone-wild','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'wawanakwa-gone-wild', emoji:'🐻', name:'Wawanakwa Gone Wild!', category:'challenge', chalSeries:'island', chalStyle:'hunt', phase:'post-merge', desc:'Post-merge animal hunt. Draw an animal, grab gear from the boathouse, and hunt it down. First capture wins immunity + a feast. Last place cleans the bathrooms. Tranq gun chaos, alliance offers, and animal mishaps.', engineType:'wawanakwa-gone-wild', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'tri-armed-triathlon', emoji:'⛓️', name:'Trial by Tri-Armed Triathlon', category:'challenge', chalSeries:'island', chalStyle:'physical', phase:'post-merge', desc:'Post-merge handcuffed pair challenge. Three sub-events: Competitive Chowdown, Idol Haul, Totem Pole of Shame. Wimp key available before each event (costs invincibility). Triple-tie = no invincibility tonight. Requires even player count (≥4); odd count gives one spectator.', engineType:'tri-armed-triathlon', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','mine-over-matter','haunted-house'], minPlayers: 4 },
  { id:'camp-castaways', emoji:'🏝️', name:'Camp Castaways', category:'challenge', chalSeries:'island', chalStyle:'endurance', phase:'post-merge', desc:'Flash flood scatters the camp. Survival scoring across 5 phases (flood, scattered, night, regrouping, storming camp). Mr. Coconut breakdown. Chris surveillance with playback callbacks. Best survivor wins individual immunity.', engineType:'camp-castaways', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'are-we-there-yeti', emoji:'🦶', name:'Are We There Yeti?', category:'challenge', chalSeries:'island', chalStyle:'hunt', phase:'post-merge', desc:'Post-merge forest navigation race. Random pairs dropped in woods. Sasquatchanakwa hunts. Overnight deception. Winning pair gets immunity. Chef picks elimination. No tribal vote.', engineType:'are-we-there-yeti', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'greeces-pieces', emoji:'🏛️', name:"Greece's Pieces", category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'any', desc:"Olympic gauntlet: maze gold hunt, tag-team wrestling, hurdle race. Most golds wins. Tied? Icarus wax-wing tiebreaker.", engineType:'greeces-pieces', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','bigger-badder-brutaler','truth-or-shark','rock-the-dock','tropical-takedown','midnight-manhunt','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'hangar-black', emoji:'👽', name:'Operation: Hangar Black', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'any', desc:'Breach a secret facility, hunt alien specimens room-by-room, extract before lockdown. Push-your-luck depth vs specimen risk.', engineType:'hangar-black', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','brunch-of-disgustingness','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','bigger-badder-brutaler','truth-or-shark','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  ...
  { id:'exile-duel',       emoji:'⚔️', name:'Exile Duel',            category:'elim',       phase:'any',        desc:'Voted-out player goes to exile instead of leaving. The NEXT boot faces them in a duel — winner returns to the game. Loser is permanently eliminated — unless Rescue Island is on, in which case the loser is sent to Rescue Island (DC4-style).', engineType:'exile-duel' },
  ...
  { id:'reward-twist-challenge', emoji:'🎁', name:'Reward Twist Challenge', category:'advantages', phase:'any', desc:'Pick any twist challenge to run as a reward-only episode. No elimination — winner gets a reward.', engineType:'reward-twist-challenge', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','truth-or-shark','bigger-badder-brutaler','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','rock-the-dock','midnight-manhunt','greeces-pieces','hangar-black','viking-sour','bridal-brawls','great-fake-out','african-lying-safari','picnic-hanging-dork','tropical-takedown','rapa-phooey','drumheller','planes-trains','ice-ice-baby','project-runaway','finders-creepers','backstabbers-ahoy','reward-challenge','no-tribal','mine-over-matter','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  ...
  { id:'rapa-phooey', emoji:'🥚', name:'Rapa Phooey!', category:'challenge',
    chalSeries:'world-tour', chalStyle:'hunt', phase:'post-merge',
    desc:'Easter Island egg hunt — search moai heads for colored eggs, traverse an underground cave, climb a pillar to nest them while dodging a giant condor.', engineType:'rapa-phooey',
    incompatible:['reward-twist-challenge','planes-trains','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'drumheller', emoji:'🦴', name:'Awwwwww, Drumheller', category:'challenge',
    chalSeries:'world-tour', chalStyle:'adventure', phase:'post-merge',
    desc:'Two-phase archaeology dig — build a dinosaur judged by forced-honesty lie-detector vote, then race to unearth buried barrels in a boulder-ridden valley. Rescue trapped rivals or leave them buried.', engineType:'drumheller',
    incompatible:['reward-twist-challenge','planes-trains','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'ice-ice-baby', emoji:'🧊', name:'Ice Ice Baby', category:'challenge',
    chalSeries:'revenge', chalStyle:'adventure', phase:'pre-merge', minTribes:2,
    desc:'Arctic mountain challenge. Summit climb, fort building, and capture-the-flag assault on ice. Tribe teamwork under freezing conditions.',
    engineType:'ice-ice-baby',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','bridal-brawls','great-fake-out','african-lying-safari','rapa-phooey','drumheller','planes-trains','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'project-runaway', emoji:'👗', name:'Project Runaway', category:'challenge',
    chalSeries:'revenge', chalStyle:'social', phase:'pre-merge', minTribes:2,
    desc:'Fashion challenge. Catch a creature, assign roles, build matching outfits, and compete in a runway show judged by the host.',
    engineType:'project-runaway',
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','bridal-brawls','great-fake-out','african-lying-safari','rapa-phooey','drumheller','planes-trains','ice-ice-baby','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'finders-creepers', emoji:'🕷️', name:'Finders Creepers', category:'challenge',
    chalSeries:'revenge', chalStyle:'hunt', phase:'pre-merge', minTribes:2,
    desc:'A found-footage night scavenger hunt across three cursed locations — haunted forest, pet cemetery, and the cave. A mutant spider and booby traps web members out of the hunt. Fewest members lost wins.',
    engineType:'finders-creepers',
    incompatible:['backstabbers-ahoy','sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','bridal-brawls','great-fake-out','african-lying-safari','rapa-phooey','drumheller','planes-trains','ice-ice-baby','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'backstabbers-ahoy', emoji:'🔪', name:'Backstabbers Ahoy!', category:'challenge',
    chalSeries:'revenge', chalStyle:'physical', phase:'pre-merge', minTribes:2,
    desc:'A two-part aquatic challenge — a brass-suit deep dive for the skis (diver + air-pump crew), then a boat race firing mutant gulls at mines. A schemer can THROW the challenge for their own team, flipping a win into a loss. Highest combined score wins immunity.',
    engineType:'backstabbers-ahoy',
    incompatible:['finders-creepers','sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','bridal-brawls','great-fake-out','african-lying-safari','rapa-phooey','drumheller','planes-trains','ice-ice-baby','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'hung-out-to-dry', emoji:'🪢', name:'Hung Out to Dry', category:'challenge',
    chalSeries:'dc4', chalStyle:'social', phase:'post-merge',
    desc:'Post-merge lie-detector endurance hang. Contestants dangle from a handlebar over a shark tank, three ropes each, wearing polygraph helmets, and interrogate one another. Lie and the helmet cuts a rope; tell the truth and keep every rope — but the honest answer exposes votes, alliances and romances. Lose your grip or your last rope and you fall. Last one hanging wins immunity.',
    engineType:'hung-out-to-dry',
    incompatible:['say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','picnic-hanging-dork','slap-slap-revolution','broadway-baby','viking-sour','planes-trains','bridal-brawls','great-fake-out','amazon-race','night-at-museum','truth-or-shark','rock-the-dock','tropical-takedown','midnight-manhunt','bigger-badder-brutaler','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','truth-or-dare-train','a-maze-ing-grip','poles-apart','hells-kitchen','trust-challenge','basic-straining','monster-cash','mine-over-matter','treasure-island','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','greeces-pieces','hangar-black','african-lying-safari','rapa-phooey','drumheller','ice-ice-baby','project-runaway','finders-creepers','backstabbers-ahoy','haunted-house','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'merry-go-round-up', emoji:'🎠', name:'Merry-Go-Round-Up', category:'challenge',
    chalSeries:'dc4', chalStyle:'physical', phase:'any',
    desc:'A spinning big-top carousel of pain. Contestants mount painted carnival animals and hold on as the ride spins faster and faster. Two meters drain you: GRIP (muscle + your animal\'s grip) and STOMACH (whether the spinning scrambles your inner ear) — so a tough challenge-beast with a weak stomach can lose to a calm floater. The host escalates with sudden stops (collisions knock neighbours off too) and direction reverses. Fall off your animal into the mud and you\'re out. Pre-merge: last team still riding wins immunity. Post-merge: last one on the ride wins immunity.',
    engineType:'merry-go-round-up',
    incompatible:['say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','picnic-hanging-dork','slap-slap-revolution','broadway-baby','viking-sour','planes-trains','bridal-brawls','great-fake-out','amazon-race','night-at-museum','truth-or-shark','rock-the-dock','tropical-takedown','midnight-manhunt','bigger-badder-brutaler','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','truth-or-dare-train','a-maze-ing-grip','poles-apart','hells-kitchen','trust-challenge','basic-straining','monster-cash','mine-over-matter','treasure-island','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','greeces-pieces','hangar-black','african-lying-safari','rapa-phooey','drumheller','ice-ice-baby','project-runaway','finders-creepers','backstabbers-ahoy','haunted-house','hung-out-to-dry','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'maze-of-the-fallen', emoji:'🌽', name:'Maze of the Fallen', category:'challenge',
    chalSeries:'dc4', chalStyle:'puzzle', phase:'post-merge',
    desc:'A moonlit hedge-maze trivia race. Survivors run the maze; at every crossroad a lantern reveals a question about an eliminated merge camper — and whether you KNOW the answer depends on how well you bonded with them. Wrong turn = a dead-end backtrack and a strike; two strikes and you\'re pulled to the pit. Runners cluster into pods where a knower leads and the herd follows (right or wrong), villains can steer rivals into dead ends on purpose, and the pit runs its own arc of reconciliations and overheard intel. First to reach the exit wins immunity. If nobody escapes, it\'s a free-for-all vote.',
    engineType:'maze-of-the-fallen',
    incompatible:['say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','picnic-hanging-dork','slap-slap-revolution','broadway-baby','viking-sour','planes-trains','bridal-brawls','great-fake-out','amazon-race','night-at-museum','truth-or-shark','rock-the-dock','tropical-takedown','midnight-manhunt','bigger-badder-brutaler','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','truth-or-dare-train','a-maze-ing-grip','poles-apart','hells-kitchen','trust-challenge','basic-straining','monster-cash','mine-over-matter','treasure-island','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','greeces-pieces','hangar-black','african-lying-safari','rapa-phooey','drumheller','ice-ice-baby','project-runaway','finders-creepers','backstabbers-ahoy','haunted-house','hung-out-to-dry','merry-go-round-up','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese','wheel-of-misfortune'] },
  { id:'demons-plainer', emoji:'🎢', name:"Demon's Plainer", category:'challenge',
    chalSeries:'dc4', chalStyle:'puzzle', phase:'any',
  ...
  { id:'bb-double-veto', emoji:'💠', name:'The Double Veto', format:'big-brother',
    category:'advantages', phase:'any',
    desc:'The veto competition puts TWO medallions in the room. The winner takes one and the houseguest who came closest to beating them takes the other, and both may be used at the same ceremony. Two nominees can come down and two replacements go up, which means the Head of Household can watch the entire block they built be replaced by a block they did not, in one meeting, by two people who did not have to agree with each other about any of it.',
    incompatible:['bb-forced-veto', 'bb-diamond-veto'],
    incompatibleModes:[] },
  { id:'bb-forced-veto', emoji:'⛓️', name:'The Forced Veto', format:'big-brother',
    category:'advantages', phase:'any',
    desc:'The medallion must be used. Whoever wins the veto this week does not get to decide whether to touch the block, only whose name comes off it — so a winner whose honest answer was "nobody" has to pick somebody anyway, put a replacement up in their place, and then live in a house with both of them. Winning it stops being protection and becomes an obligation with a name attached.',
    incompatible:['bb-double-veto'],
    incompatibleModes:[] },
  { id:'bb-team-america', emoji:'🎖️', name:'Team America', format:'big-brother',
    category:'social', phase:'any',
    desc:'The audience picks three houseguests, tells each of them privately that they are now a team, and starts sending them jobs: start a rumour and make it travel, cause an argument you are not in, put a specific name on the block without ever suggesting it out loud. Every completed mission pays all three. Failing one costs nothing — being CAUGHT doing it sets the house hunting for a saboteur. Nobody chose this alliance and nobody can refuse it, so three players who may be on opposite sides of the house and actively targeting each other are now obliged to be seen together often enough to plan. The better they are at the job, the more obviously they are working together.',
    incompatible:[],
    incompatibleModes:[] },
  { id:'bb-camp-comeback', emoji:'⛺', name:'Camp Comeback', format:'big-brother',
    category:'returns', phase:'any',
    desc:'The next four houseguests voted out do not leave. They move into Camp Comeback — a camper’s uniform, a bad bed and a small television — and go on living in the house with the people who evicted them. They cannot compete, cannot vote and cannot be nominated, so they have total information, no stake and nothing left to lose, which makes a camper the only honest person in the building. When the fourth arrives all four play for a single place back in the game: one walks back into the house carrying four weeks of overheard conversations, and the other three are gone for good.',
    incompatible:['bb-battle-back'],
    incompatibleModes:[] },
  { id:'bb-prizes-and-punishments', emoji:'🎁', name:'Prizes and Punishments', format:'big-brother',
    category:'power', phase:'any',
    desc:'The veto competition stops awarding the veto and starts deciding who picks first. Everybody then chooses a wrapped box: the Power of Veto is in one of them, and the rest hold cash, a holiday, a call home, a bag of confetti, or a punishment nobody wants. Finish last in the competition and you pick first, blind; win it and you pick last, with every opened box on the table and stealable. Anything stolen once is frozen and can never be taken again, so the veto changes hands in public until somebody makes it stop — and every season this format runs, somebody on the block chooses the money.',
    // The block’s shape is untouched, but the veto’s route is not, so
  ...
  { id:'bb-secret-power-comp', emoji:'🎭', name:'Secret Power Competition', format:'big-brother',
    ...
    incompatible:[] },
  { id:'bb-hidden-power', emoji:'🔍', name:'Something In This House', format:'big-brother',
    category:'advantages', phase:'any',
    desc:'A real power is hidden somewhere in the house — behind the cereal, under a have-not bed, in the HOH cistern — and the house is told only that it exists. No clue, no competition, no map. The only way to hold it is to go and look, and looking is not a private act: a houseguest seen rummaging is a houseguest who visibly believes there is something to find, which costs them and makes everybody else start looking too. Whoever finds it is told nothing publicly. If nobody finds it in four evictions it is taken away and the house never learns it was there.',
    incompatible:[] },
  ...
  { id:'tr-plain-sight', emoji:'🍷', name:'In Plain Sight', format:'traitors',
    ...
    incompatible:['tr-on-trial','tr-face-to-face','tr-dungeon','tr-double-murder','tr-name-your-own','tr-recruitment','tr-hidden-murder','tr-chalice','tr-death-match'] },
  { id:'tr-face-to-face', emoji:'⛪', name:'Face to Face', format:'traitors',
    ...
    incompatible:['tr-on-trial','tr-plain-sight','tr-dungeon','tr-double-murder','tr-name-your-own','tr-recruitment','tr-hidden-murder','tr-chalice','tr-death-match'] },
  { id:'tr-dungeon', emoji:'🔦', name:'The Dungeon', format:'traitors',
    ...
    incompatible:['tr-on-trial','tr-plain-sight','tr-face-to-face','tr-double-murder','tr-name-your-own','tr-recruitment','tr-hidden-murder','tr-chalice','tr-death-match'] },
  { id:'tr-double-murder', emoji:'🩸', name:'Double Murder', format:'traitors',
    ...
    incompatible:['tr-on-trial','tr-plain-sight','tr-face-to-face','tr-dungeon','tr-name-your-own','tr-recruitment','tr-hidden-murder','tr-chalice','tr-death-match'] },
  { id:'tr-name-your-own', emoji:'🗡️', name:'Name Your Own', format:'traitors',
    ...
    incompatible:['tr-on-trial','tr-plain-sight','tr-face-to-face','tr-dungeon','tr-double-murder','tr-recruitment','tr-hidden-murder','tr-chalice','tr-death-match'] },
  { id:'tr-hidden-murder', emoji:'⚰️', name:'Hidden Murder', format:'traitors',
    category:'murder', phase:'any', variant:'hidden', engineType:'tr-murder-variant',
    desc:'Nobody is told who died. The victim and two others are kept away from breakfast, so the castle sits down to three empty chairs and one murder. That afternoon is The Funeral: a procession, clues about who is safe, three coffins, and a vote on which of the three is really dead. Needs 7+ alive, 3+ Faithful, and missions switched on.',
    incompatible:['tr-on-trial','tr-plain-sight','tr-face-to-face','tr-dungeon','tr-double-murder','tr-name-your-own','tr-recruitment','tr-chalice','tr-death-match'] },
  { id:'tr-chalice', emoji:'🍷', name:'The Poisoned Chalice', format:'traitors',
    category:'murder', phase:'any', variant:'chalice', engineType:'tr-murder-variant',
    desc:'No conclave. The Traitors must first find a poisoned chalice hidden among a set of books, and then one of them pours it and hands it to somebody in front of the whole room. If they cannot find it, nobody is murdered at all and the castle is never told why. If they do, the room wakes up trying to remember who put a glass in the victim’s hand — one name, not a set, which is how the show’s own pourer was banished the next night. Sometimes nobody can recall it, and the night says nothing. Needs 6+ alive, 1+ Traitor, 3+ Faithful.',
    incompatible:['tr-on-trial','tr-plain-sight','tr-face-to-face','tr-dungeon','tr-double-murder','tr-name-your-own','tr-recruitment','tr-hidden-murder','tr-death-match'] },
  { id:'tr-death-match', emoji:'🃏', name:'Death Match', format:'traitors',
    category:'murder', phase:'any', variant:'death-match', engineType:'tr-murder-variant',
    desc:'The Traitors still meet and still agree on a name — but that name only buys a seat. Four players are summoned to a game of cards: eight cards between them, one of them a life card, and whoever finds it walks away. Play until two are left, then the last eight go face-down in a circle and they draw in turn until the life card turns up. The loser is murdered face-to-face. Three nights in four the cards take somebody the pact never wanted, and if a Traitor took a chair as cover, the pact has to murder one of its own in front of everybody. Needs 7+ alive, 4+ Faithful.',
    incompatible:['tr-on-trial','tr-plain-sight','tr-face-to-face','tr-dungeon','tr-double-murder','tr-name-your-own','tr-recruitment','tr-hidden-murder','tr-chalice'] },
  // A night the pact RECRUITS instead of killing — so nobody is murdered and
  // only the banishment removes anyone (one elimination, not two; the timeline
  // knows). It can only run once the room has already banished a Traitor (the
  // show's rule, enforced by the engine's canRecruit); pinned before that, the
  // night falls back to an ordinary murder. Mutually exclusive with the six
  // murder shapes — a night is one thing or the other.
  { id:'tr-recruitment', emoji:'🤝', name:'Recruitment', format:'traitors',
    ...
    incompatible:['tr-on-trial','tr-plain-sight','tr-face-to-face','tr-dungeon','tr-double-murder','tr-name-your-own','tr-hidden-murder','tr-chalice','tr-death-match'] },
  ...
  { id:'pm-bombshell-dates', emoji:'\u{1F339}', name:'Just Dates', format:'perfect-match',
    ...
    incompatible:['pm-stand-up','pm-bombshell-saves','pm-public-matches','pm-sleepover'] },
  { id:'pm-stand-up', emoji:'\u{1F64B}', name:'Stand Up To Be Chosen', format:'perfect-match',
    ...
    incompatible:['pm-bombshell-dates','pm-bombshell-saves','pm-public-matches','pm-sleepover'] },
  { id:'pm-bombshell-saves', emoji:'\u{1F6DF}', name:'The Bombshell Saves One', format:'perfect-match',
    ...
    incompatible:['pm-bombshell-dates','pm-stand-up','pm-public-matches','pm-sleepover'] },
  { id:'pm-public-matches', emoji:'\u{1F4F2}', name:'The Public Couple Them', format:'perfect-match',
    ...
    incompatible:['pm-bombshell-dates','pm-stand-up','pm-bombshell-saves','pm-sleepover'] },
  { id:'pm-first-step-forward', emoji:'\u{1F463}', name:'Step Forward', format:'perfect-match',
    ...
    incompatible:['pm-first-profiles','pm-first-public','pm-first-ranking','pm-first-icebreakers','pm-first-lady-luck'] },
  { id:'pm-first-profiles', emoji:'\u{1F4C7}', name:'Dating Profiles', format:'perfect-match',
    ...
    incompatible:['pm-first-step-forward','pm-first-public','pm-first-ranking','pm-first-icebreakers','pm-first-lady-luck'] },
  { id:'pm-first-public', emoji:'\u{1F4FA}', name:'The Public Choose', format:'perfect-match',
    ...
    incompatible:['pm-first-step-forward','pm-first-profiles','pm-first-ranking','pm-first-icebreakers','pm-first-lady-luck'] },
  { id:'pm-first-ranking', emoji:'\u{1F4CA}', name:'Most To Least', format:'perfect-match',
    ...
    incompatible:['pm-first-step-forward','pm-first-profiles','pm-first-public','pm-first-icebreakers','pm-first-lady-luck'] },
  { id:'pm-first-icebreakers', emoji:'\u{1F9CA}', name:'Icebreakers', format:'perfect-match',
    category:'first', phase:'any', engineType:'pm-first-icebreakers', pmOn:['first-coupling'], pmApply:{ firstFormat:'icebreakers' },
    desc:'Both sides walk in and meet, and then the ice comes out. Each islander in turn smashes an ice cube to get the card frozen inside, reads its question out loud (the one you would most like to wake up next to, the best kisser, the one who caught your eye first) and answers it by kissing someone from the other side. A kiss with someone who fancies you back lands, and both of you fancy each other more for it; one that does not lands flat. Once everyone has kissed, the side that walked in first chooses their partners one by one, and the kisses have already changed who they want.',
    incompatible:['pm-first-step-forward','pm-first-profiles','pm-first-public','pm-first-ranking','pm-first-lady-luck'] },
  { id:'pm-first-lady-luck', emoji:'\u{1F340}', name:'Lady Luck', format:'perfect-match',
  ...
  /* The one card on the Villa Challenges shelf (user: "a dropdown to choose a
     ...
     the season and is not already booked (pm/schedule.js resolveRandomGames).
     The per-challenge cards below stay for seasons booked before it, off the
     shelf (`pmHidden`). */
  { id:'pm-villa-challenge', emoji:'\u{1F3AF}', name:'Villa Challenge', format:'perfect-match',
    category:'games', phase:'any', engineType:'pm-villa-challenge', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'random' },
    desc:"The afternoon's game, booked on the day you want it. Pick one from the dropdown on the timeline, or leave it on Random and the show chooses one that fits that part of the season — the guess-who cards early on, the kissing and quiz games in the middle, the lie detector, talent show and baby dolls near the end — never one already booked on another night. Each game is an excuse to put something in front of the villa: a secret on a card, a partner's score read aloud, a red light on the question that mattered. If the villa cannot play it that day (not enough couples), the day runs without a game.",
    incompatible:['pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  /* ── THE VILLA'S CHALLENGES (Perfect Match, Plan 4.5 phase 4) ──
     The afternoon's game (pm/challenges.js), one a day: drawn when they are
     not booked, on the kind of day the real show plays them. */
  { id:'pm-got-the-receipts', emoji:'\u{1F9FE}', name:"Got the Receipts", format:'perfect-match',
    category:'games', pmHidden:true, phase:'any', engineType:'pm-got-the-receipts', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'receipts' },
    desc:"Boys against girls. Each islander takes a card with something an islander on the other side has done this week, printed from what the cameras saw: kissed someone behind their partner's back, pulled someone for a chat while coupled up, had a row, said they are falling for someone. They guess who by kissing them, then the card is turned over. A wrong guess is a kiss for somebody else in front of their partner, and a right one reads the secret out to the one it was kept from.",
    incompatible:['pm-villa-challenge','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-look-whos-talking', emoji:'\u{1F5E3}', name:"Look Who's Talking", format:'perfect-match',
    category:'games', pmHidden:true, phase:'any', engineType:'pm-look-whos-talking', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'look-who' },
    desc:"A box of cards, each with a line an islander said in the beach hut about somebody else in the villa. One islander reads a card aloud and has to name who said it; then the answer is given. Nobody wins anything. The cost is that the one it was about has now heard it: a kind line warms them, a cold one stings, and a line that said one thing to camera and another to their face costs trust.",
    incompatible:['pm-villa-challenge','pm-got-the-receipts','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-sauciest-snogger', emoji:'\u{1F48B}', name:"Sauciest Snogger", format:'perfect-match',
    category:'games', pmHidden:true, phase:'any', engineType:'pm-sauciest-snogger', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'snogger' },
    desc:"The boys sit blindfolded in a row and the girls take it in turns to kiss every one of them. Each boy scores each kiss out of ten without knowing whose it was, and the scores are read out. What goes wrong is the reading out: a partner who gave somebody else two points more than he gave his own girl has done it in front of the whole villa. The girl with the highest total wins.",
    incompatible:['pm-villa-challenge','pm-got-the-receipts','pm-look-whos-talking','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-couple-goals', emoji:'\u{1F3AF}', name:"Couple Goals", format:'perfect-match',
    category:'games', pmHidden:true, phase:'any', engineType:'pm-couple-goals', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'couple-goals' },
    desc:"Every couple sits with a board. For each question — which couple is most likely to get married, which is the fakest, which will be the first to break up on the outside — they write down another couple, and the boards are turned round together. Nobody wins. What goes wrong is finding out that friends wrote you down as the fakest couple in the villa; the couple most of the boards named has it said to their face.",
    incompatible:['pm-villa-challenge','pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-knowing-me', emoji:'\u{1F4DD}', name:"Knowing Me, Knowing You", format:'perfect-match',
    category:'games', pmHidden:true, phase:'any', engineType:'pm-knowing-me', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'knowing-me' },
    desc:"The couples sit back to back and answer questions about each other on boards — who said I love you first, who is messier, what the other one's favourite food is — then turn them round. Matching answers score. A settled couple who talk matches more; a new one guesses. The last question is which of you is more likely to stray, and a board with your partner's name on it starts the argument. Most matches wins.",
    incompatible:['pm-villa-challenge','pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-talent-show', emoji:'\u{1F3A4}', name:"The Talent Show", format:'perfect-match',
    category:'games', pmHidden:true, phase:'any', engineType:'pm-talent-show', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'talent' },
    desc:"Every islander does an act on the terrace: a song, a dance, a magic trick, or a duet with their partner. Nerve counts for more than talent, and an act can fall apart in front of everyone (the public tend to love the one who tried). Then the villa votes by a show of hands, so a partner whose hand goes up for somebody else does it in front of everyone. The most hands wins.",
    incompatible:['pm-villa-challenge','pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-baby-dolls','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-baby-dolls', emoji:'\u{1F37C}', name:"The Baby Dolls", format:'perfect-match',
    category:'games', pmHidden:true, phase:'any', engineType:'pm-baby-dolls', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'baby' },
    desc:"Each couple is handed a baby doll that cries, and has to look after it day and night: the feeds, the changes, the three-in-the-morning wake-up. Nobody wins. What it shows is who gets up and who rolls over — a partner left doing all of it notices, and so does the public — and a couple who leave the doll by the pool for three hours give the villa the funniest afternoon of the week.",
    incompatible:['pm-villa-challenge','pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-couple-of-sorts','pm-grafties'] },
  { id:'pm-couple-of-sorts', emoji:'\u{1F3C5}', name:"Couple of Sorts", format:'perfect-match',
    category:'games', pmHidden:true, phase:'any', engineType:'pm-couple-of-sorts', pmOn:['recoupling','bombshell','public-vote','photos','semi-final'], pmApply:{ challenge:'couple-of-sorts' },
    desc:"The public have ranked the couples, and the villa is told only the categories. Each couple stands on the first, second or third podium where they think they placed, then the real order is read out: the public's favourite couple, and last of all the couple least likely to last on the outside. It is the first time the villa hears what the country thinks. Standing on first and being placed last is what goes wrong.",
    incompatible:['pm-villa-challenge','pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-grafties'] },
  { id:'pm-grafties', emoji:'\u{1F396}', name:"The Grafties", format:'perfect-match',
    category:'games', pmHidden:true, phase:'any', engineType:'pm-grafties', pmOn:['public-vote'], pmApply:{ challenge:'grafties' },
    desc:"An awards night on the evening of a public vote, with every award voted for by the public: their favourite couple, the grafter of the year and, last, the islander they like least. The winners go up and make a speech. It goes wrong for whoever takes the last award, and for a partner who hears theirs named grafter of the year, just before the public decide who is dumped.",
    incompatible:['pm-villa-challenge','pm-got-the-receipts','pm-look-whos-talking','pm-sauciest-snogger','pm-couple-goals','pm-knowing-me','pm-talent-show','pm-baby-dolls','pm-couple-of-sorts'] },
  /* ── THE VILLA'S ONE-OFFS (Perfect Match, Plan 4.5 phase 3) ──
     At most two a season when drawn (ONE_OFF_DRAWS); booked here, they play
     on the night they are booked on. */
  { id:'pm-returning-islander', emoji:'\u{1F519}', name:'Returning Islander', format:'perfect-match',
    category:'returns', phase:'any', engineType:'pm-returning-islander', pmOn:['bombshell','recoupling'], pmApply:{ oneOff:'return' },
    desc:'A text: the islanders have a visitor. One of the islanders already dumped walks back in, single, and the public decide who — the one they most want back. Their ex is still in there, possibly with somebody new, and so is everyone who voted them out. On a recoupling night they walk in first and pick first.' },
  { id:'pm-secret-task', emoji:'\u{1F92B}', name:'The Secret Task', format:'perfect-match',
    category:'arrivals', phase:'any', engineType:'pm-secret-task', pmOn:['bombshell'], pmApply:{ oneOff:'mission' },
    desc:'Before walking in, the new arrival is given a secret task by the host: choose one boy and one girl to dump. At the fire pit they have to name them, and the two leave — then get a text giving them a second chance, and walk back in. Nobody goes home, but the villa knows exactly who the new arrival was willing to send away, and so do the two they chose.' },
  { id:'pm-sleepover', emoji:'\u{1F6CF}', name:'The Sleepover Villa', format:'perfect-match',
    category:'arrivals', phase:'any', engineType:'pm-sleepover', pmOn:['bombshell'], pmApply:{ oneOff:'sleepover' },
    desc:'Needs a night with two or more new arrivals. Each one takes an islander who is coupled up to a separate villa for two nights. Then every invited islander chooses: go back to their partner, or couple up with the one who invited them. A new arrival nobody chose is dumped; a partner left behind is suddenly single. It takes the whole night, so no other arrival rule plays with it.',
    incompatible:['pm-bombshell-dates','pm-stand-up','pm-bombshell-saves','pm-public-matches'] },
  ...
  { id:'pm-top-couple-picks', emoji:'\u{1F451}', name:'The Favourites Decide', format:'perfect-match',
    category:'dumping', phase:'any', engineType:'pm-top-couple-picks', pmFormat:'top-couple-picks', pmSlots:['vote1','vote2','vote-post','vote3'],
  ...
  { id:'pm-public-vote', emoji:'\u{1F4F1}', name:'Straight Public Vote', format:'perfect-match',
    category:'dumping', phase:'any', engineType:'pm-public-vote', pmFormat:'public', pmSlots:['vote1','vote2','vote-post','vote3','semi'],
  ...
  { id:'pm-safe-pick-couple', emoji:'\u{1F6E1}', name:'The Safe Islanders Pick', format:'perfect-match',
    category:'dumping', phase:'any', engineType:'pm-safe-pick-couple', pmFormat:'safe-pick-couple', pmSlots:['vote2','vote-post','vote3'],
  ...
  { id:'pm-couples-vote', emoji:'\u{1F5F3}', name:'Least Compatible', format:'perfect-match',
    category:'dumping', phase:'any', engineType:'pm-couples-vote', pmFormat:'couples-vote', pmSlots:['vote2','vote-post','vote3'],
...
export function defaultConfig() {
  return {
    ...
    drAllStars: false, drAllStarsRule: 'legacy', drAllStarsTwist: 'none', drAllStarsTwistEp: 0,
    drAllStarsJury: false,
    ...
    themeArcStamped: '',      // whose arc is already laid on twistSchedule and editable by hand
...
export let currentChalSeries  = 'all';
...
export function setCurrentChalSeries(v)  { currentChalSeries = v; }
...
export async function loadAll() {
  ...
  try {
    const { _idbGet, _idbPut, _idbKeys } = await import('./savestate.js');
    const idbGs = await _idbGet('gs');
    if (idbGs) {
      gs = idbGs;
      repairGsSets(gs);
    } else {
      // Migration: try localStorage
      const lsGs = localStorage.getItem('simulator_gs');
      if (lsGs) {
        gs = JSON.parse(lsGs);
        repairGsSets(gs);
        // Migrate to IndexedDB and remove from localStorage
        _idbPut('gs', JSON.parse(lsGs));
        localStorage.removeItem('simulator_gs');
      }
    }

    // ── Checkpoints: load from IndexedDB, fall back to localStorage for migration ──
    const idbKeys = await _idbKeys();
    const cpKeys = idbKeys.filter(k => typeof k === 'string' && k.startsWith('cp_'));
    for (const key of cpKeys) {
      const epNum = Number(key.replace('cp_', ''));
      if (epNum) {
        const cpData = await _idbGet(key);
        if (cpData) { gsCheckpoints[epNum] = cpData; repairGsSets(gsCheckpoints[epNum]); }
      }
    }
    // Migration: check localStorage for old checkpoint keys
    if (cpKeys.length === 0) {
      for (let i = 0; i < localStorage.length; i++) {
        ...
        if (key?.startsWith('simulator_cp_')) {
          ...
          if (epNum) {
            const cpData = JSON.parse(localStorage.getItem(key));
            gsCheckpoints[epNum] = cpData;
            repairGsSets(gsCheckpoints[epNum]);
            // Migrate to IndexedDB and remove from localStorage
            _idbPut('cp_' + epNum, cpData);
    ...
    // Fallback: load from localStorage if IndexedDB is unavailable
    try { const g = localStorage.getItem('simulator_gs'); if (g) { gs = JSON.parse(g); repairGsSets(gs); } } catch(e2) { gs = null; }
    try {
      for (let i = 0; i < localStorage.length; i++) {
        const key = localStorage.key(i);
        if (key?.startsWith('simulator_cp_')) {
