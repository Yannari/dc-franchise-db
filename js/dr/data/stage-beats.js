     ...
     in her mouth here. See docs/PROSE-PROMPT-dr-exit-moods.md. */
  {
    ...
    tiers: [
      tier('bitter', 'She is angry, and it is at people rather than at the result.', [
        '{a} does not move. She stands exactly where she was standing when the name was called and her jaw is tight and her eyes are on the host and she is deciding what not to say.',
        'The room watches {a} and nobody steps forward. Her jaw is set and her eyes are fixed on a point past the judges — not a place, a person she will not look at directly.',
        '{a} turns her head toward the panel and then turns it back. Whatever she was about to start she has decided against. Her hands are fists inside her gloves.',
        'There is a silence around {a} that the other queens are choosing not to break. She is radiating something the room can feel and the room has decided, collectively, to give it space.',
        '{a} smiles and the smile is the most frightening thing the stage has produced all night. It is perfectly controlled and it reaches nowhere near her eyes and it says everything her mouth is not going to.',
        '{a} straightens her shoulders and lifts her chin. It is not pride. It is a wall going up in real time because the alternative is saying something she cannot take back.',
      ]),
      tier('gutted', 'She does not hold it together.', [
        '{a} puts a hand over her mouth but the sound comes first. Her shoulders drop and she folds forward and one of the other queens takes a step toward her.',
        'The tears arrive before {a} is ready for them. She blinks once, twice, and on the third blink they are on her face and the make-up she spent two hours on is already going with them.',
        '{a} takes one step toward the wings and her knees do something her knees have never done on this stage — they bend when she did not ask them to. One of the safe queens moves toward her without being told.',
        '{a} covers her face with both hands and stands there behind them, breathing hard. The judges can hear it from the table.',
        'It hits {a} in the chest. She folds forward at the waist, catches herself on her own thighs, and stays there. The stage waits.',
        '{a} nods and keeps nodding long after there is anything to agree with. The nodding becomes shaking and then the shaking becomes crying.',
      ]),
      tier('robbed', 'It was close and she believes she won it.', [
        '{a} looks at the host, then the judges, then back at the host. She is replaying the song in her head and arriving at a different answer each time.',
        '{a} blinks. She blinks again. The second blink is slower than the first, as if her body is asking the room to say it again because the first time did not add up.',
        'Something crosses {a}\'s face that is not sadness and not anger — it is the expression of a woman holding a receipt she was not expecting to need. She glances at the other queen and the glance is a measurement.',
        '{a} stands perfectly still. Her eyes move from the host to the panel to the wings and back, running numbers that will not land on the same total twice.',
        'The name lands and {a} takes half a step backward. Not a stumble — just a shift. Her chin stays up and her eyes stay on the host.',
        '{a} exhales through her nose, once, hard, and the exhale carries everything she is not going to say out loud. She had evidence and the evidence was not enough and the gap between those two facts is visible on her face.',
      ]),
      tier('blindsided', 'She had never been in the bottom before tonight.', [
        '{a} looks at the host like she needs to hear it again. She has never stood on this side of this moment and her body does not know what to do with itself.',
        'The name is hers and {a} hears it from somewhere far away. Her hands, which have spent every main stage knowing exactly where to go, hang at her sides like they belong to somebody else.',
        '{a}\'s face does something the cameras have not seen before — it goes completely blank. Not composed, not brave, just empty, the way a screen looks the moment before it loads.',
        'One of the safe queens backstage puts a hand over her own mouth because she recognises what is happening to {a} before {a} does. {a} is still standing in the posture of someone who expected to be safe.',
        '{a} touches her own collarbone lightly, as if checking she is still here. She has never rehearsed this moment. Every other one she had a version of in her head beforehand.',
        'The room shifts around {a}. The energy moves toward the queen who survived and away from her, and she can feel the gap opening. She is still standing where the safe queens stood a moment ago.',
      ]),
      tier('relieved', 'It is over and she is all right about that.', [
        '{a}\'s shoulders drop two inches. She exhales and there is a smile hiding inside the exhale. It is the most honest thing she has done on this stage in weeks.',
        '{a} nods once and the nod is real. Not brave, not performing — just at peace. The other queens look at her expecting tears and do not know what to do when they do not come.',
        'Something loosens in {a}\'s face that has been held tight since the premiere. The judges are watching for the break and the break is not coming because there is nothing left to break.',
        '{a} takes a breath so deep it lifts her chest and lets it out slowly. She looks like someone putting down something heavy she has been carrying for weeks.',
        'The other queens look at {a} expecting tears and what they find instead is a woman who is already lighter. She almost laughs — catches it — and the catching is more embarrassing to her than the leaving.',
        '{a} closes her eyes for a moment and when she opens them the stage looks smaller to her. She is already somewhere else in her head, and the somewhere else looks fine.',
      ]),
      tier('resigned', 'She has been down here before and saw it coming.', [
        '{a} nods before the name is fully out of the host\'s mouth. She heard the first syllable and that was enough. She has done this math before and she did it again this morning.',
        'There is no surprise on {a}\'s face. There has not been surprise on her face since the critiques, maybe longer. She used up her shock episodes ago.',
        '{a} turns toward the wings with the efficiency of someone who has packed this bag before. Her steps are even and measured and the measuring is not bravery, it is practice.',
        'The host says the name and {a} receives it the way she has received every piece of bad news this season — standing, steady, already looking at what comes next. The feeling finished arriving days ago.',
        '{a}\'s face settles into an expression the other queens have seen before — in the werk room, when a challenge was announced she knew she could not win. She is ahead of this moment by about forty-eight hours.',
        '{a} looks down at the stage and then up at the lights. She started saying goodbye to this room three episodes ago and is only now finishing it in front of everybody.',
      ]),
      tier('composed', 'She takes it cleanly, and the composure is the story.', [
        '{a} nods once, straightens her back, and clasps her hands together. Her knuckles are white but her face gives the room nothing.',
        '{a} swallows hard and then stands very still. She worked out how she wanted to leave and she is doing it exactly the way she planned.',
        'The other queens wait for {a} to cry and she does not cry. She blinks once, sets her jaw, and looks at the host like she is accepting an award she did not want.',
        '{a} presses her lips together, squares her shoulders, and exhales through her nose. Whatever she is feeling she has decided the cameras are not getting it.',
        '{a} smooths the front of her garment and looks up. Her eyes are wet but her posture is perfect and she is not going to let one win without the other.',
        '{a} stands the way she has stood at every judging — feet together, chin up, hands still. The only difference is a tightness at the corner of her jaw that was not there before.',
      ]),
    ],
  },
  {
