...
export const MORE_CHALLENGE_LINES = {
  ...
  'blow-slip': [
    { id: 'bs.01', turns: T("Sorry! Sorry. That was an accident."), beat: "It didn't look like much of an accident, and the whole line saw it." },
  ...
  'blow-dare': [
    ...
    { id: 'bd.o.02', when: { of: 'kiss-other', taken: true }, turns: [['a', "Do I have to?"], ['b', "It's a dare. You have to."]], beat: "It's a long kiss. {c} doesn't clap." },
    ...
    { id: 'bd.o.04', when: { of: 'kiss-other', taken: true }, turns: [['a', "I'm not choosing. I'm really not choosing."]], beat: '{a} chooses {b} straight away, and {c} notices.' },
    ...
    { id: 'bd.f.03', when: { of: 'forfeit' }, stage: 'The dare: an impression of another islander.', turns: T("Guess who I am."), beat: "Everyone gets it straight away, and the person it's about laughs the loudest." },
  ],
  'lip-race': [
    { id: 'lsv.w.01', when: { of: 'win' }, turns: [['a', "We won! We actually won!"], ['b', "Best team in here. I told you."]], beat: 'They celebrate with a kiss.' },
    ...
    { id: 'lsv.l.01', when: { of: 'laugh' }, turns: [['a', "Most of that went down my top."], ['b', "Most of it went down mine."]], beat: "They're laughing too hard to finish." },
  ...
  'lip-watch': [
    { id: 'lw.01', stage: "{a} watches {b} and {c} win, and doesn't clap.", turns: [['a', "Good for them."]], beat: "It doesn't sound like {a} means it." },
  ...
  'tower-q': [
    ...
    { id: 'tq.oh.02', when: { of: 'other-honest' }, turns: [['b', "Who would you pick if it wasn't me?"], ['a', "Do you want the truth?"], ['b', "That's the game."], ['a', "{c}."]], beat: 'The tower wobbles, and {b} goes red.' },
    ...
    { id: 'tq.rl.01', when: { of: 'rate-low' }, turns: [['b', "'Out of ten, how happy are you with me?'"], ['a', "Four?"], ['b', "Four?"]], beat: 'The tower falls over.' },
    { id: 'tq.rl.02', when: { of: 'rate-low' }, turns: [['b', "Out of ten?"], ['a', "Can I pass?"], ['b', "No."], ['a', "…Three."]] },
    { id: 'tq.i.01', when: { of: 'ick' }, turns: [['b', "'What's your ick about me?'"], ['a', "Do you really want to know?"], ['b', "Now I do."], ['a', "The way you eat cereal. It's loud."]], beat: '{b} looks horrified.' },
  ...
  'course-run': [
    { id: 'cr.s.01', when: { of: 'strong' }, stage: "{a} flies round the course and doesn't miss a single obstacle.", turns: T("Is that it? I could go again.") },
    { id: 'cr.s.02', when: { of: 'strong' }, stage: '{a} finishes the course and still has the breath to show off.', turns: T("Did everyone get that? Should I do it again?") , beat: 'The judges love it.' },
  ...
  'course-pick': [
    ...
    { id: 'cp.o.01', when: { of: 'other' }, stage: '{a} runs straight past {c} and stops at {b}.', turns: [['a', "It's just a game."]], beat: "{c} isn't smiling." },
    ...
    { id: 'cp.o.03', when: { of: 'other' }, stage: 'The whole villa gasps when {a} goes to {b} instead of {c}.', turns: [['c', "Wow. Okay."]], beat: "{a} doesn't look back at {c} for the rest of the challenge." },
  ...
  'blind-run': [
    ...
    { id: 'blc.cl.01', when: { of: 'crash-laugh' }, turns: [['a', "Right! Right! No, my right!"]], beat: "{b} walks straight into the pool. They're both crying with laughter." },
  ...
  headline: [
    ...
    { id: 'hl.p.r.02', when: { of: 'pull', guessed: true }, turns: [['a', "'Loved-up islander not so loved-up after late-night chat.'"], ['c', "Why is everyone looking at me?"]], beat: "The drink hits {c} before {c} has finished the sentence. {d} doesn't laugh." },
    ...
    { id: 'hl.p.w.02', when: { of: 'pull', guessed: false }, turns: [['a', "'Loved-up islander not so loved-up after late-night chat.'"]], beat: "{a} soaks {b}. It wasn't {b}. {c} keeps very still." },
    // row
    { id: 'hl.r.r.01', when: { of: 'row', guessed: true }, turns: [['a', "'Villa hothead kicks off. Again.'"], ['c', "That's so unfair."]], beat: "Nobody else thinks it's unfair. {c} is wearing the drink." },
    { id: 'hl.r.w.01', when: { of: 'row', guessed: false }, turns: [['a', "'Villa hothead kicks off. Again.'"], ['b', "Me? I'm the calmest person in here!"]], beat: "Everyone turns to look at {c}, who doesn't argue." },
    // ick
    ...
    { id: 'hl.i.w.01', when: { of: 'ick', guessed: false }, turns: [['a', "'Islander goes off partner over the smallest thing.'"]], beat: '{a} soaks {b}. {c} looks away.' },
    // love
    ...
    // jealous
    { id: 'hl.j.r.01', when: { of: 'jealous', guessed: true }, turns: [['a', "'Green-eyed islander can't handle partner chatting to anyone.'"], ['c', "I'm not jealous. I'm observant."]], beat: 'The drink hits {c} full in the face.' },
