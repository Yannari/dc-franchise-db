...
export const JUST_MET = {
  chat: [
    ...
    { id: 'jm.chat.08', when: J, turns: [['a', "So, what's your type? Honestly."], ['b', "I'm working that out. Ask me again in a couple of days."]], beat: '{b} looks at {a} for a second longer than necessary.' },
  ...
  'deep-chat': [
    ...
    { id: 'jm.deep.10', when: J, turns: [['a', "I was really worried nobody would talk to me today."], ['b', "I was worried about the same thing. And then you did."]], beat: 'They sit quietly for a while, and it is not awkward.' },
  ],
  kiss: [
