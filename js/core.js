...
export const TWIST_CATALOG = [
  ...
  { id:'get-a-clue', emoji:'🔍', name:'Get a Clue', category:'challenge', chalSeries:'action', chalStyle:'puzzle', phase:'post-merge', desc:'Murder mystery challenge. DNA collection via traps & hunts, murder investigation on a train with blackout events, and a Danganronpa-style trial arc with presentation, cross-examination, and deduction. Courtroom vote winner gets immunity; perfect solver can earn a second immunity.', engineType:'get-a-clue', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified','super-hero-ld','princess-pride','rock-n-rule','houston','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'crouching-courtney', emoji:'🥋', name:'Way of the Warrior', category:'challenge', chalSeries:'action', chalStyle:'chaos', phase:'post-merge', desc:'Kung fu challenge. Training montage with fighter/trainer pairs, robot fight bracket with joystick controls, and mountain climb with water cup balance, cooperation temptation, and Sasquatchanakwa boss. Mole becomes saboteur if active.', engineType:'crouching-courtney', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','houston','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'houston', emoji:'🚀', name:'Houston, We Have a Problem', category:'challenge', chalSeries:'action', chalStyle:'adventure', phase:'post-merge', desc:'Space station challenge. Zero-G clue hunt for pod components, RED ALERT crisis with timed pod repair, re-entry shakedown (vomit = eliminated), and station sprint obstacle race. Mole sabotages from the shadows. First to escape the fake Earth station wins immunity.', engineType:'houston', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','top-dog','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  ...
  { id:'walk-like-an-egyptian', emoji:'🏛️', name:'Walk Like an Egyptian', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', desc:'Three-phase tribe race through an Egyptian pyramid (over or under), desert trek with reward animals (camel/goat/stick), and Nile crossing with crocodile gauntlet. Curse of the Mummified Dog persists for 3 episodes. First tribe across wins immunity.', engineType:'walk-like-an-egyptian', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','bigger-badder-brutaler','frozen-crossing','amazon-race','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'crazy-fun-time', emoji:'🎮', name:'Super Happy Crazy Fun Time', category:'challenge', chalSeries:'world-tour', chalStyle:'social', phase:'pre-merge', desc:'Game show challenge. Human Pinball — one rep per tribe bounces in a giant pinball machine with an animal buddy. Candy Commercial — tribes pitch, debate, and produce an ad for Chef\'s candy, judged by Chef with a hidden preference quirk.', engineType:'crazy-fun-time', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','frozen-crossing','amazon-race','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'frozen-crossing', emoji:'🧊', name:'Frozen Crossing', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'pre-merge', desc:'Two-phase arctic challenge. Ice Floe Gauntlet — all tribes cross a shared frozen river with polar bear attacks, rescues, and a cold meter. Sled Pickup Race — first finisher pulls a sled to collect teammates, with romance traps and the Bridgette Rule.', engineType:'frozen-crossing', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','amazon-race','picnic-hanging-dork','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'picnic-hanging-dork', emoji:'🦘', name:'Picnic at Hanging Dork', category:'challenge', chalSeries:'world-tour', chalStyle:'adventure', phase:'any', desc:'Outback emu race through four terrain segments with momentum system, then bungee into a canyon to grab sheep and shear them for wool. Post-merge: solo emu race + golden fleece hunt for individual immunity.', engineType:'picnic-hanging-dork', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  ...
  { id:'bridal-brawls', emoji:'💒', name:'Bridal Brawls', category:'challenge',
    ...
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','great-fake-out','planes-trains','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'great-fake-out', emoji:'🏯', name:'The Great Fake-Out', category:'challenge',
    ...
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','bridal-brawls','planes-trains','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'amazon-race', emoji:'🌿', name:'The Am-AH-Zon Race', category:'challenge',
    ...
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','night-at-museum','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  ...
  { id:'phobia-factor', emoji:'😱', name:'Phobia Factor', category:'challenge', chalSeries:'island', chalStyle:'social', phase:'pre-merge', desc:'Each player faces their worst fear. Tribe with the best completion rate wins immunity. Worst tribe goes to tribal. Triple points clutch for losing tribe.', engineType:'phobia-factor', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'cliff-dive', emoji:'🏔️', name:'Cliff Dive', category:'challenge', chalSeries:'island', chalStyle:'physical', phase:'pre-merge', desc:'Three-phase tribe challenge: cliff jump (willingness), crate haul (physical), hot tub build (mental). Chickens get blame on losing tribe.', engineType:'cliff-dive', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'awake-a-thon', emoji:'😴', name:'Awake-A-Thon', category:'challenge', chalSeries:'island', chalStyle:'endurance', phase:'pre-merge', desc:'Three-phase endurance: 20km run, feast trap, then stay awake. Last team standing wins. Mid-challenge social events fire between dropouts.', engineType:'awake-a-thon', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'dodgebrawl', emoji:'🏐', name:'Dodgebrawl', category:'challenge', chalSeries:'island', chalStyle:'chaos', phase:'pre-merge', desc:'Multi-round dodgeball. All tribes on the court — first to 3 wins immunity. Highlights, heroics, and blame.', engineType:'dodgebrawl', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'talent-show', emoji:'🎭', name:'Talent Show', category:'challenge', chalSeries:'island', chalStyle:'social', phase:'pre-merge', desc:'Camp talent show. Each tribe auditions, captain picks 3 acts. Chef scores 0-9. Disasters, clutch moments, and villain sabotage.', engineType:'talent-show', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'sucky-outdoors', emoji:'🏕️', name:'The Sucky Outdoors', category:'challenge', chalSeries:'island', chalStyle:'endurance', phase:'pre-merge', desc:'Overnight survival in the woods. Five phases of drama. First tribe back in the morning wins. Getting lost can cost your team everything.', engineType:'sucky-outdoors', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'up-the-creek', emoji:'🛶', name:'Up the Creek', category:'challenge', chalSeries:'island', chalStyle:'adventure', phase:'pre-merge', desc:'Canoe race to Boney Island and back. Pick your partner. Portage through danger. Build a fire. Race home. Partner chemistry matters.', engineType:'up-the-creek', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'paintball-hunt', emoji:'🎯', name:'Paintball Deer Hunter', category:'challenge', chalSeries:'island', chalStyle:'hunt', phase:'pre-merge', desc:'Paintball hunt. Half your tribe are hunters, half are deer. Hunters track opposing deer. Last tribe with unpainted deer wins. Social chaos guaranteed.', engineType:'paintball-hunt', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'truth-or-dare-train', emoji:'🚂', name:'Truth or Dare Train', category:'challenge', chalSeries:'dc4', chalStyle:'social', phase:'pre-merge', desc:'Teams race cart-to-cart to the front of a moving train. Every camper takes one Truth or Dare hot seat. Complete it to advance; refuse and your team eats a 5-minute penalty. Fastest team wins immunity.', engineType:'truth-or-dare-train', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'a-maze-ing-grip', emoji:'🌽', name:'A-Maze-ing Grip', category:'challenge', chalSeries:'dc4', chalStyle:'endurance', phase:'pre-merge', desc:'Corn-maze net challenge. Each team commits 2 holders suspending their net plus a designated dunker; the rest raid the maze for coconuts and sink them into a rival net to strain their holders. Holders can swap. Last net standing wins immunity.', engineType:'a-maze-ing-grip', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','poles-apart','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'poles-apart', emoji:'🏖️', name:'Poles Apart', category:'challenge', chalSeries:'dc4', chalStyle:'physical', phase:'pre-merge', desc:'Beach tug-of-war melee, best of three rounds. Each team plants 3 holders gripping poles; the rest swarm the rival holders and drag them across the center line. Down all their holders to win the round. Gang-ups, resist moves, and sit-outs. First to two rounds wins immunity.', engineType:'poles-apart', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'tusks-and-ladders', emoji:'🐘', name:'Tusks and Ladders', category:'challenge', chalSeries:'dc4', chalStyle:'chaos', phase:'pre-merge',
    ...
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','poles-apart','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'killer-clown', emoji:'🤡', name:'Night of the Killer Clown', category:'challenge', chalSeries:'dc4', chalStyle:'adventure', phase:'post-merge',
    ...
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','poles-apart','tusks-and-ladders','bumper-car-bash','say-cheese'] },
  { id:'bumper-car-bash', emoji:'🎡', name:'Bumper Car Bash', category:'challenge', chalSeries:'dc4', chalStyle:'physical', phase:'post-merge',
    ...
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','poles-apart','tusks-and-ladders','killer-clown','say-cheese'] },
  { id:'say-cheese', emoji:'📸', name:'Say Cheese', category:'challenge', chalSeries:'dc4', chalStyle:'adventure', phase:'post-merge',
    ...
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','truth-or-dare-train','a-maze-ing-grip','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','poles-apart','tusks-and-ladders','killer-clown','bumper-car-bash'] },
  { id:'hells-kitchen', emoji:'🔥', name:"Hell's Kitchen", category:'challenge', chalSeries:'island', chalStyle:'chaos', phase:'pre-merge', desc:'Cooking challenge. Head chef leads the team through 3 courses. Kitchen chaos, sabotage, and food fights determine who serves the best meal.', engineType:'hells-kitchen', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'trust-challenge', emoji:'🤝', name:"Who Can You Trust?", category:'challenge', chalSeries:'island', chalStyle:'social', phase:'pre-merge', desc:'Three trust tests. Chris picks the worst pairs. Rock climb, fugu cooking, blind challenges. Trust is earned or destroyed.', engineType:'trust-challenge', minTribes:2, incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  ...
  { id:'lucky-hunt', emoji:'🗝️', name:'Lucky Hunt', category:'challenge', chalSeries:'island', chalStyle:'hunt', phase:'post-merge', desc:'Post-merge scavenger hunt. Every player searches for a key. One chest hides immunity — the others hold food, traps, and surprises. Hunt, help, steal, and scheme.', engineType:'lucky-hunt', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','wawanakwa-gone-wild','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'hide-and-be-sneaky', emoji:'🔫', name:'Hide and Be Sneaky', category:'challenge', chalSeries:'island', chalStyle:'hunt', phase:'post-merge', desc:'Post-merge hide-and-seek. Chef hunts with a water gun. Stay hidden, escape to home base, or betray allies. 1-2 immunity winners. Betrayal mechanics, archetype-driven loyalty decisions.', engineType:'hide-and-be-sneaky', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','off-the-chain','wawanakwa-gone-wild','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'off-the-chain', emoji:'🚲', name:"That's Off the Chain!", category:'challenge', chalSeries:'island', chalStyle:'chaos', phase:'post-merge', desc:'Post-merge bike-building and racing. Build a bike, swap with a rival, two-part race with obstacle gauntlet. Bikes fall apart mid-race. Sabotage, rivalry, and demolition derby chaos.', engineType:'off-the-chain', incompatible:['slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','wawanakwa-gone-wild','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'wawanakwa-gone-wild', emoji:'🐻', name:'Wawanakwa Gone Wild!', category:'challenge', chalSeries:'island', chalStyle:'hunt', phase:'post-merge', desc:'Post-merge animal hunt. Draw an animal, grab gear from the boathouse, and hunt it down. First capture wins immunity + a feast. Last place cleans the bathrooms. Tranq gun chaos, alliance offers, and animal mishaps.', engineType:'wawanakwa-gone-wild', incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','tri-armed-triathlon','camp-castaways','are-we-there-yeti','monster-cash','alien-egg','beach-blanket-bogus','planes-trains','project-runaway','mine-over-matter','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  ...
  { id:'rapa-phooey', emoji:'🥚', name:'Rapa Phooey!', category:'challenge',
    ...
    incompatible:['reward-twist-challenge','planes-trains','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  ...
  { id:'project-runaway', emoji:'👗', name:'Project Runaway', category:'challenge',
    ...
    incompatible:['sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','bridal-brawls','great-fake-out','african-lying-safari','rapa-phooey','drumheller','planes-trains','ice-ice-baby','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'finders-creepers', emoji:'🕷️', name:'Finders Creepers', category:'challenge',
    ...
    incompatible:['backstabbers-ahoy','sudden-death','slasher-night','triple-dog-dare','say-uncle','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','hells-kitchen','trust-challenge','basic-straining','x-treme-torture','monster-cash','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','walk-like-an-egyptian','bigger-badder-brutaler','truth-or-shark','crazy-fun-time','frozen-crossing','slap-slap-revolution','broadway-baby','amazon-race','night-at-museum','brunch-of-disgustingness','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','operation-classified','super-hero-ld','princess-pride','get-a-clue','rock-n-rule','crouching-courtney','houston','top-dog','viking-sour','picnic-hanging-dork','rock-the-dock','tropical-takedown','midnight-manhunt','greeces-pieces','hangar-black','bridal-brawls','great-fake-out','african-lying-safari','rapa-phooey','drumheller','planes-trains','ice-ice-baby','project-runaway','haunted-house','hung-out-to-dry','merry-go-round-up','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  ...
  { id:'merry-go-round-up', emoji:'🎠', name:'Merry-Go-Round-Up', category:'challenge',
    ...
    incompatible:['say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','picnic-hanging-dork','slap-slap-revolution','broadway-baby','viking-sour','planes-trains','bridal-brawls','great-fake-out','amazon-race','night-at-museum','truth-or-shark','rock-the-dock','tropical-takedown','midnight-manhunt','bigger-badder-brutaler','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','truth-or-dare-train','a-maze-ing-grip','poles-apart','hells-kitchen','trust-challenge','basic-straining','monster-cash','mine-over-matter','treasure-island','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','greeces-pieces','hangar-black','african-lying-safari','rapa-phooey','drumheller','ice-ice-baby','project-runaway','finders-creepers','backstabbers-ahoy','haunted-house','hung-out-to-dry','maze-of-the-fallen','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
  { id:'maze-of-the-fallen', emoji:'🌽', name:'Maze of the Fallen', category:'challenge',
    ...
    incompatible:['say-uncle','operation-classified','super-hero-ld','princess-pride','get-a-clue','crouching-courtney','houston','top-dog','walk-like-an-egyptian','crazy-fun-time','frozen-crossing','picnic-hanging-dork','slap-slap-revolution','broadway-baby','viking-sour','planes-trains','bridal-brawls','great-fake-out','amazon-race','night-at-museum','truth-or-shark','rock-the-dock','tropical-takedown','midnight-manhunt','bigger-badder-brutaler','rock-n-rule','brunch-of-disgustingness','phobia-factor','cliff-dive','awake-a-thon','dodgebrawl','talent-show','sucky-outdoors','up-the-creek','paintball-hunt','truth-or-dare-train','a-maze-ing-grip','poles-apart','hells-kitchen','trust-challenge','basic-straining','monster-cash','mine-over-matter','treasure-island','alien-egg','beach-blanket-bogus','crazytown','chefshank','one-flu','masters-of-disasters','oceans-heist','million-bucks-bc','sports-marathon','full-metal-drama','x-treme-torture','lucky-hunt','hide-and-be-sneaky','off-the-chain','wawanakwa-gone-wild','tri-armed-triathlon','camp-castaways','are-we-there-yeti','greeces-pieces','hangar-black','african-lying-safari','rapa-phooey','drumheller','ice-ice-baby','project-runaway','finders-creepers','backstabbers-ahoy','haunted-house','hung-out-to-dry','merry-go-round-up','demons-plainer','tusks-and-ladders','killer-clown','bumper-car-bash','say-cheese'] },
